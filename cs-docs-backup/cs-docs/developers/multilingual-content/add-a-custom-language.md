...
You can create and add a custom language of your choice to your [stack](../set-up-stack/about-stack.md). With appropriate permissions, you will be able to create and publish [entries](../../content-managers/author-content/about-entries.md) in your custom language.
...
After adding the language to the stack, the [content manager](../invite-users-and-assign-roles/types-of-roles.md#content-manager) can add an entry in the specified language or create [localized entries](./about-localization.md).

**Note:** The content manager can view or create content in multiple languages only for the languages added to the stack by the [Admin](../invite-users-and-assign-roles/types-of-roles.md#admin)/[Developer](../invite-users-and-assign-roles/types-of-roles.md#developer).

## API Reference

To add a custom language to your stack via API request, refer to the [Add a language](../../../api-docs/api-detail/content-management-api.md#add-a-language) API request.
...
A: The content manager can view or create content in multiple languages only for the languages added to the stack by the [Admin](../invite-users-and-assign-roles/types-of-roles.md#admin)/[Developer](../invite-users-and-assign-roles/types-of-roles.md#developer).