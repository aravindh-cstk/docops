---
title: "[PHP] - About PHP Utils Library"
description: About the Contentstack PHP Utils library and its features.
url: https://www.contentstack.com/docs/developers/sdks/utils-sdk/php/about-php-utils-library
...
# [PHP] - About PHP Utils Library

This page describes what the Contentstack PHP Utils library is, what features it includes, and where to go next to start using it in a PHP application. It is intended for developers integrating Contentstack content into frontend applications using the PHP SDK utilities.
...
### What is the PHP Utils library used for?
It contains utilities for the PHP SDK, including support for working with embedded objects in Rich Text Editor fields.

### What are “Embedded Objects” in this context?
