...
url: https://www.contentstack.com/docs/developer-hub/sidebar-location
...
The Entry Sidebar Location provides powerful functionalities that you can integrate into your [stack](../set-up-stack/about-stack.md) to analyze your [entry](../../content-managers/author-content/about-entries.md) content and recommend ideas.  
...
A: You can use the prebuilt [boilerplate](./marketplace-app-boilerplate.md) and modify the given code to suit your requirements.