...
- Once satisfied with the content, click **Save **to save the entry variant.**Note: **Once saved, the entry variants become independent of the base entry. For more details, refer to the [manage versions of entry variants](./manage-versions-of-entry-variants.md) document.
