...
description: GET /content_types/{content_type_uid}/entries?locale={locale_code}&query={ 'field_UID': { '$nin': [ value1, value2, ...]}}
url: developers/apis/content-delivery-api/requests/array-not-equals-operator
