...
description: GET /content_types/{content_type_uid}/entries?locale={locale_code}&query={ 'modular_block_UID.block_UID.field_UID': { '$in': [ value1, value2, ...] } }
url: developers/apis/content-delivery-api/requests/array-equals-operator-within-modular-blocks
