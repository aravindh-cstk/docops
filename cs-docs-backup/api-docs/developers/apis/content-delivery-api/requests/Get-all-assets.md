...
description: GET /assets?environment={environment_name}&include_fallback=true&include_dimension={boolean_value}
url: developers/apis/content-delivery-api/requests/get-all-assets
