...
description: GET /content_types/{content_type_uid}/entries?environment={environment_name}&locale={locale_code}&asc={group_UID.field_UID}
url: developers/apis/content-delivery-api/requests/order-by-asc-operator-within-group
