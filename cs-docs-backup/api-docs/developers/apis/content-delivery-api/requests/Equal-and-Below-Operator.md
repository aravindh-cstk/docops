...
description: GET /taxonomies/entries?query={'taxonomies.taxonomy_uid' : { '$eq_below': 'term_uid', 'levels' : level_number}}
url: developers/apis/content-delivery-api/requests/equal-and-below-operator
