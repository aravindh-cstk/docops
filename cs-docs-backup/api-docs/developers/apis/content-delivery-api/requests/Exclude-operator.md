...
description: GET /content_types/{content_type_uid}/entries?locale={locale}&except[BASE][]=field_UID
url: developers/apis/content-delivery-api/requests/exclude-operator
...
**Note**: To exclude multiple fields use the following syntax:
