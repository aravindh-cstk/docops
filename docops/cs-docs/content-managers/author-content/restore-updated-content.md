...
**Note:** Only a **Stack**[** Owner**](../../developers/organization/organization-roles.md#stack-owner)**/**[**Admin**](../../developers/organization/organization-roles.md#stack-admin) or **Organization **[**Owner**](../../developers/organization/organization-roles.md#organization-owner)**/**[**Admin**](../../developers/organization/organization-roles.md#organization-admin) can submit or approve requests to restore content.

This guide provides an overview of how to restore data lost due to entries and content type updates.

## Content Types

If changes were made to a content type (e.g., modifying a field UID or deleting a field), you can retrieve previous versions of the content type using the [Contentstack Management API](../../../api-docs/api-detail/content-management-api.md).

Perform the following steps to restore a prior version of a content type:
- Use a REST API client, such as [Postman](https://www.postman.com/) or [Swagger](https://swagger.io/tools/swagger-ui/), and execute the [Get a single content type API](../../../api-docs/api-detail/content-management-api.md#get-a-single-content-type) request.
...
When fields are updated or deleted from a content type schema, any data associated with those fields in the entries may be lost. To address this, follow our step-by-step guide to [restore lost entry data](../../developers/content-modeling/content-type-change-management.md).
