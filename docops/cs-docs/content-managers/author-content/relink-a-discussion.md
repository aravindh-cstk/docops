...
- **Marking fields as "Multiple" or reverting them to "Single":** Fields such as “[Group](../../developers/create-content-types/group.md),” “[Modular Blocks](../../developers/create-content-types/modular-blocks.md),” or “[Global](../../developers/global-field/about-global-field.md)” are made up of multiple subfields, and you can create discussions for each subfield. However, when you change the parent field to “[Multiple](../../developers/create-content-types/multiple.md),” the discussion loses track of the subfield it was linked to. The same issue occurs when you change a parent field from "Multiple" back to "Single".
...
- Go to the unlinked discussion and click on **ReLink**.![Relink_a_Discussion2.png](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/bltbf979925b2963403/678df59abf5204a1da7cf7fb/Relink_a_Discussion2.png)
- A popup titled **Relink Field With** appears with a list of alternative fields from which you can select one to link this discussion to.
