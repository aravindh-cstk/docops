...
The Dashboard Extension is a type of extension that lets you create extensions for your [stack dashboard](../set-up-stack/about-stack-dashboard.md). Using this, you can create several useful extensions, such as a extension that does the following:
...
- **Recently Modified Entries**: Displays the list of [entries](../../content-managers/author-content/about-entries.md) that were recently modified by any user of the [stack](../set-up-stack/about-stack.md).
...
Once you [create a dashboard extension](./create-a-new-dashboard-extension.md), you can see it on Stack’s Dashboard page. Contentstack allows you to [customize your Dashboard view](../set-up-stack/customize-your-dashboard-view.md) and arrange extensions as per requirements.
...
Once you [create a dashboard extension](./create-a-new-dashboard-extension.md), you can see it on Stack’s Dashboard page.
