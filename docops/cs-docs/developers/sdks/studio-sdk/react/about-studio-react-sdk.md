...
**Note:** Initialize the Studio React SDK with a Contentstack Delivery SDK instance with [Live Preview](../../../../content-managers/author-content/about-live-preview.md) enabled. Without Live Preview, editing capabilities won’t work.
...
To integrate your React application with the Studio React SDK, follow the steps in the [Get Started ](./get-started-with-studio-react-sdk.md)document.

## Common questions

### Do I need Live Preview to use the Studio React SDK?
Yes. **Note:** Initialize the Studio React SDK with a Contentstack Delivery SDK instance with [Live Preview](../../../../content-managers/author-content/about-live-preview.md) enabled. Without Live Preview, editing capabilities won’t work.
...
Follow the steps in the [Get Started ](./get-started-with-studio-react-sdk.md)document.