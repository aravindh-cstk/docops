...
Contentstack Launch allows you to host static sites on Launch by [importing projects from Git repositories](./import-project-using-github.md) or by [uploading a zip file](./import-project-using-file-upload.md).

By using the steps mentioned in the [Other Frameworks on Launch](./other-frameworks-on-launch.md#hosting-a-static-site-on-launch) guide, you will be able to host a static site on Launch.
...
Use the steps mentioned in the [Other Frameworks on Launch](./other-frameworks-on-launch.md#hosting-a-static-site-on-launch) guide.
