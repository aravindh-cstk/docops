...
When modifying a [content type](../create-content-types/about-content-types.md) schema after creating and publishing entries, there is a risk of data loss. However, by following specific guidelines, you can make changes safely without impacting the content on your live site or app.
...
To understand these scenarios, we will consider an example. You have a content type named **Product,** and there are several [fields](../create-content-types/about-fields.md) within the **Product** content type:
- **Name:** [Single Line Textbox](../create-content-types/single-line-textbox.md) (String data type)
- **Price:** Single Line Textbox (String data type)
- **Description:** [Rich Text Editor](../create-content-types/rich-text-editor.md) (String data type) for displaying the product’s description

You have [created](../../content-managers/author-content/create-an-entry.md) and [published](../../content-managers/author-content/publish-an-entry.md) multiple entries for the “Product” content type. Now let’s look at the changes that you want to perform and the steps to be followed to perform the changes.
...
- **Edit the content type:** Go to the [stack](../set-up-stack/about-stack.md) and [edit](../create-content-types/edit-a-content-type.md) the **Product** content type.
- **Add the new field:** Click the “Insert a field” (+) button and select **Single Line Textbox**.
- **Publish entries on staging:** [Edit existing entries](../../content-managers/author-content/edit-an-entry.md) to populate data in the new field, then save and [publish](/docs/content-managers/publish-content) these entries on the staging environment.
...
- **Edit entries:** Manually [edit](../../content-managers/author-content/edit-an-entry.md) all the existing entries, and enter new data in the **Price_new** field.
...
- **Add the deleted field to the content type:** Edit the content type and re-add the deleted field. Ensure that you use the exact UID of the original field; otherwise, the data cannot be retrieved. If you are unsure of the field's UID, consider using the [API method](./content-type-change-management.md#restore-content-through-api) instead.
- **Retrieve the required version of the entries:** [Compare the versions](../../content-managers/author-content/compare-entry-versions.md) of each entry to identify the version containing the data for the restored field. Repeat this process for all entries in the content type.
...
- **Create a copy of the content type:** [Copy](../create-content-types/copy-a-content-type.md) the existing content type.
...
- **Delete old content type:** After confirming that the new content type is functional, [delete](../create-content-types/delete-a-content-type.md) the old content type.
