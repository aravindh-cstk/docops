---
title: "Exists"
description: /content_types/{content_type_uid}/entries?locale={locale_code}&query={"field_UID": { "$exists": true } }
url: /exists
product: Contentstack
doc_type: api-request
created_at: 2023-01-05T14:09:00.042Z
updated_at: 2024-07-01T05:32:27.644Z
---

# Exists

<p>Get entries if value of the field, mentioned in the condition, exists.<span>This query will work for entries only.</span></p><p><strong>Example:</strong> In the <span data-type='inlineCode'>Product</span> content type, we have a field named <span data-type='inlineCode'>Price in USD</span>. Now, you want to retrieve all the entries in the content type in which the field exists. You can send the parameter as:</p><p><span data-type='inlineCode'>{ "price_in_usd": { "$exists": true } }</span>.</p><h5 id="exists-operator-within-group">Exists Operator Within Group</h5>

**API Endpoint**: `/content_types/{content_type_uid}/entries?locale={locale_code}&query={"field_UID": { "$exists": true } }`
