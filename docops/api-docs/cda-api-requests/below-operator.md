---
title: "Below Operator"
description: /taxonomies/entries?query={"taxonomies.taxonomy_uid" : { "$below": "term_uid", "levels" : 2}}
url: /below-operator
product: Contentstack
doc_type: api-request
created_at: 2023-11-16T12:00:34.394Z
updated_at: 2025-07-15T11:49:02.915Z
---

# Below Operator

<p>Get all entries for a specific taxonomy that match all of their descendant terms by specifying only the target term and a specific level.</p><p class="note"><strong>Note:</strong> If you don't specify&nbsp;the level, the default behavior is to retrieve terms up to <strong>level 10</strong>.</p><pre>query={<br />  "taxonomies.taxonomy_uid" : { "$below": "term_uid", "levels" : 2}<br />}</pre><p><strong>Example</strong>: If you want to retrieve all entries containing terms nested under <span class="code">blue</span>, such as <span class="code">navy blue</span> and <span class="code">sky blue</span>, but exclude entries that solely have the target term <span class="code">blue</span>.</p><pre>query={<br />  "taxonomies.color" : { "$below": "blue" }<br />}</pre><h5 id="equal-and-above-operator">Equal and Above Operator</h5>

**API Endpoint**: `/taxonomies/entries?query={"taxonomies.taxonomy_uid" : { "$below": "term_uid", "levels" : 2}}`
