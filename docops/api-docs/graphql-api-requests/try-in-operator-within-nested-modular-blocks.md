---
title: "Try 'In' Operator within Nested Modular Blocks"
description: /stacks/apiKey/explore
url: /try-in-operator-within-nested-modular-blocks
product: Contentstack
doc_type: api-request
created_at: 2023-01-05T14:09:18.768Z
updated_at: 2023-03-30T10:34:44.109Z
---

# Try 'In' Operator within Nested Modular Blocks

<p><strong>In Operator within </strong><strong>Nested Modular Blocks</strong></p>
...
<p>If, for instance, you need to retrieve all the entries where the value of the "Coupon Discount Rate" field is one among the given set of values, your query will look as follows:</p>
<pre>query {
  all_product(
    where: {
      additional_info: {
