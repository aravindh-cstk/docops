...
**Additional Resource:** Deleting a branch also deletes the [alias](../developer-apis/content-management-api/branches.md#work-with-aliases) pointing towards it.
...
An [alias](../developer-apis/content-management-api/branches.md#work-with-aliases) acts as a pointer to a particular branch. You can specify the alias ID in your frontend code to pull content from the target branch associated with an alias.
