...
This is a temporary test article verifying nested-folder sync, image upload, callouts, and full text formatting for **Studio**. Safe to delete after verification.
...
```bash
echo "docops nested sync test for Studio"
```
