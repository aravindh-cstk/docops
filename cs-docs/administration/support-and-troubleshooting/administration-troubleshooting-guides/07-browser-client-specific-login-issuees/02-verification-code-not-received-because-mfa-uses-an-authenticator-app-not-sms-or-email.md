...
url: /administration/support-and-troubleshooting/administration-troubleshooting-guides/07-browser-client-specific-login-issuees/02-verification-code-not-received-because-mfa-uses-an-authenticator-app-not-sms-or-email
doc_type: faq
