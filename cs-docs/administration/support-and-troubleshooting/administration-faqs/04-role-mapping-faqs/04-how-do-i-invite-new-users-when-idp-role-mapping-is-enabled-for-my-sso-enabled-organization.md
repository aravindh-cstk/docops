...
url: /administration/support-and-troubleshooting/administration-faqs/04-role-mapping-faqs/04-how-do-i-invite-new-users-when-idp-role-mapping-is-enabled-for-my-sso-enabled-organization
doc_type: faq
...
To invite external users, open the **App Switcher**, go to **Administration**, click **Single Sign-On**, open the connection that has strict mode enabled, and disable **Strict Mode**. Then invite them as usual from Contentstack. Remember to select the Allow login without SSO checkbox.
