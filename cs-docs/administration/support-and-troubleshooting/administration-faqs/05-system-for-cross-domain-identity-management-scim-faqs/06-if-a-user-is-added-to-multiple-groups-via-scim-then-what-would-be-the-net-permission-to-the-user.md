...
url: /administration/support-and-troubleshooting/administration-faqs/05-system-for-cross-domain-identity-management-scim-faqs/06-if-a-user-is-added-to-multiple-groups-via-scim-then-what-would-be-the-net-permission-to-the-user
doc_type: faq
