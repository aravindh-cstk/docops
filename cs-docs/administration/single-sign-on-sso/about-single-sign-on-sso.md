...
**Note:** SSO can only be set up by the [owner](/docs/administration/about-administration-roles) of an [organization](/docs/administration/about-organizations).
...
   
Contentstack uses the most-commonly adopted SSO standard, i.e., Security Assertion Markup Language 2.0 (SAML 2.0). Consequently, our SSO implementation can be integrated with any well-known identity provider (IdP) that supports SAML 2.0. You can refer to our [SSO Guides](/docs/administration) section to learn how you can integrate SSO with any IdP.

**Note:** You can now enable encryption for the SAML attributes via your IdP. [Read more](/docs/administration/enable-saml-encryption).
