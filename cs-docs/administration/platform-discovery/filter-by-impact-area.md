...
Platform Discovery includes an **Impact Areas** filter that helps you identify features aligned with specific business objectives. Use this filter to focus on capabilities that support your organization's priorities.

### Prerequisites

-   [Contentstack account](https://www.contentstack.com/login/)
-   Platform Discovery enabled for the Organization
...
Platform Discovery maps features to business outcomes. This approach helps teams connect technical capabilities with strategic initiatives.

The following seven impact areas are available as filter values.
