...
Teams groups users so you can assign organization, product, and project-level roles to many people at once. The following scenarios show when Teams is the right tool and how it applies in practice. For an overview of the feature, refer to the [About Teams](/docs/administration/about-teams) documentation.
...
**Additional Resource:** For step-by-step instructions, refer to the [Create a Team](/docs/administration/create-a-team) documentation.
