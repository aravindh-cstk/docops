---
title: "DocOps Nested Test - Marketplace Platform Guides"
description: "Temporary nested test for Marketplace Platform Guides: local images, all four callout types, lists, tables, code blocks, and links."
url: /marketplace/docops-nested-test-platform
---

# DocOps Nested Test - Marketplace Platform Guides

## Overview

This is a temporary test article verifying nested-folder sync, image upload, callouts, and full text formatting for **Marketplace Platform Guides**. Safe to delete after verification.
...
```bash
echo "docops nested sync test for Marketplace Platform Guides"
```
