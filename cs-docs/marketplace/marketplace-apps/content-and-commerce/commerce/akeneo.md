...
With the Contentstack Marketplace Akeneo app, you can add products and categories from Akeneo account within your Contentstack entries via [Custom Fields](/docs/developer-hub/custom-field-location). You can also view the product details and search for the products directly in the [Sidebar Widget](/docs/developer-hub/sidebar-location).

## Prerequisites

-   [Akeneo account](https://contentstack.demo.cloud.akeneo.com/user/login)
...
1.  ## Retrieve Configuration Details from Akeneo
    ...
    1.  Log in to the [Akeneo account](https://contentstack.demo.cloud.akeneo.com/user/login) using your Akeneo account credentials.
