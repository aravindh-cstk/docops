...
-   [commercetools account](https://mc-api.europe-west1.gcp.commercetools.com/logout?reason=legacy-hostname)
...
1.  ## Create a New commercetools API Client
    ...
    1.  Log in to your account at the [commercetools Merchant Center](https://mc-api.europe-west1.gcp.commercetools.com/logout?reason=legacy-hostname) and select your project.
