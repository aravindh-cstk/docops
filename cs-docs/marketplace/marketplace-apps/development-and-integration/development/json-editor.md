...
2.  ## Use JSON Editor within your Stack
    ...
    3.  In the Content Type Builder page, add a [Custom field](/docs/developers/create-custom-fields/about-custom-fields) in your content type by clicking the **Insert a field** link represented by a **+** sign.
