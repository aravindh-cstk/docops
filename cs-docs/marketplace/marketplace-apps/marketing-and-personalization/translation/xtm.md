...
4.  ## Use the XTM App for Machine Translation
    ...
    **Note:** If you want to use the [JSON Rich Text Editor](/docs/headless-cms/about-json-rich-text-editor/) field, you can select the XTM pre-configured JSON RTE template option from the **Filter Template** drop-down. To configure the Filter Templates in your [XTM account](https://xtm.ai/), please contact XTM support.
    ...
    2.  Select **XTM** from the dropdown and fill in all the fields under the **Translate** tab.
        ...
        2.  Select the **Language** or **Template** option:
            1.  **Language**: If you want to use **Language**, choose the respective radio button. Then select the locales from the **Language** dropdown, and choose the **Filter Template**.
                ...
                **Note:** If you are using the [JSON Rich Text Editor](/docs/headless-cms/about-json-rich-text-editor/) field, select the JSON RTE Filter template option in your [XTM account](https://xtm.ai/).
