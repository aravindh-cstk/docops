---
title: "DocOps Nested Test - Marketplace Apps"
description: "Temporary nested test for Marketplace Apps: local images, all four callout types, lists, tables, code blocks, and links."
url: /marketplace/docops-nested-test-apps
---

# DocOps Nested Test - Marketplace Apps

## Overview

This is a temporary test article verifying nested-folder sync, image upload, callouts, and full text formatting for **Marketplace Apps**. Safe to delete after verification.
...
```bash
echo "docops nested sync test for Marketplace Apps"
```
