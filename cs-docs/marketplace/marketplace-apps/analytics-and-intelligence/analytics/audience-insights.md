...
description: "Install the Audience Insights app to connect Data & Insights (Lytics) with Contentstack and uncover real-time audience data to drive smarter, personalized content decisions."
...
2.  ## Use the Audience Insights App within your Stack
    ...
    1.  Go to the stack dashboard. On the left-hand side primary navigation, you will find the **Audience Insights** app icon.![Audience-Insights-Full-Page-App-Icon](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/blt0e52692eb52e1615/683aa535afd14d75a5625da1/Audience-Insights-Full-Page-App-Icon.png)
        
        **Note:** If you have enabled the **App Switcher**, the icon will be available at the top under the **Apps** section.
    ...
    2.  Click the app icon to view the Audience Insights app within your CMS.![Audience-Insights-Full-Page-App](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/blt9d0ff51d30ed0a8b/683d297aa2cdc214cea95561/Audience-Insights-Full-Page-App.png)
        ...
        -   #### Opportunity Explorer
            ...
            -   **Topic Name**: The specific content topic being analyzed in the chart (e.g., sun). Click the **Topic** to view the details and create audiences.![Audience-Insights-Opportunity-Explorer-Create-Audience](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/blt0691e1dcb38a3eeb/683b5dd622d56961e93544e9/Audience-Insights-Opportunity-Explorer-Create-Audience.png)
                ...
                -   **Create Audience**: Allows you to build a new audience segment based on the selected topic by clicking the **Create Audience** button. Then, provide the **Audience Name** and click the **Confirm** button.![Audience-Insights-Opportunity-Explorer-Create-Audience-Modal](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/blt121d70f422f1afab/683aa53f64e286f814bc3931/Audience-Insights-Opportunity-Explorer-Create-Audience-Modal.png)
                    ...
                    The audience will be created in Data & Insights (Lytics).
