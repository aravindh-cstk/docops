...
-   [Contentstack Account](https://www.contentstack.com/login/) with [Lytics enabled](/docs/lytics/manage-a-lytics-project#manage-connections) for your Organization
-   A [Lytics project](/docs/lytics/understanding-your-lytics-project-setup) connected to the specific stack where you want to use the app.
-   Access to the Contentstack Organization/Stack as the Owner/Admin

## Steps for Execution

1.  [How the Audience Insights App Becomes Available in your Stack](#how-the-audience-insights-app-becomes-available-in-your-stack)
2.  [Use the Audience Insights app within your stack](#use-the-audience-insights-app-within-your-stack)

1.  ## Enable the Audience Insights App for your Stack

    Audience Insights doesn't have a manual installation step. Once you configure **Lytics** for your organization and connect a Lytics project to a stack, the app becomes available in that stack automatically.

    **Additional Resource:** For steps on configuring Lytics and connecting a project to a stack, refer to the [Lytics](/docs/lytics/about-lytics) documentation.

2.  ## Use the Audience Insights App within your Stack

    Once the app is available in your stack, you can access it from both the Full Page and Entry Sidebar locations.
    ...
    1.  Go to the stack dashboard. 
    2.  In the top navigation bar, click **Apps**.
    3.  Select **Audience Insights** from the dropdown to open it within your CMS.

        ![Audience-Insights-In-App-Switcher](https://assets.contentstack.io/spaces/am51d76353d996c1fe/assets/blt9ff9d3d1a7f8cce0/683b5deef809c1215f3e0820/Audience-Insights-In-App-Switcher.png?locale=en-us)
    4.  The app consists of three sections:
    ...
    1.  Go to the stack dashboard and navigate to the **Entries** page. Open the entry and you will find the **Audience Insights** app icon in the right navigation panel.![Audience-Insights-Entry-Sidebar-App-Icon](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/blt70f349b9c55be014/683aa535d6b7cb2411211d70/Audience-Insights-Entry-Sidebar-App-Icon.png)
