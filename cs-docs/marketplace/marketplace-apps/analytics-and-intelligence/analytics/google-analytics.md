...
-   [Google Analytics account](https://analytics.google.com/analytics/web/provision/#/provision)
...
1.  ## Fetch View ID, Property ID and Service Account Details
    ...
    1.  **Create a Project**: Go to the Google Cloud Console and click **CREATE PROJECT** to create a new project.  
    ...
    2.  **Generate Service Account Key**: Follow the steps to generate the service account JSON file:
        1.  Navigate to Service Accounts and select your project.
    ...
    3.  **Enable API Access**: Follow the [Create and delete service account keys](https://docs.cloud.google.com/iam/docs/keys-create-delete) documentation to enable the API access for your project.  
    ...
    1.  Go to the APIs & Service dashboard in the Google Cloud Platform.
    ...
    2.  Now, go to your [Google Analytics account](https://analytics.google.com/analytics/web/provision/#/provision).
    ...
    1.  Go to your [Google Analytics account](https://analytics.google.com/analytics/web/provision/#/provision).
