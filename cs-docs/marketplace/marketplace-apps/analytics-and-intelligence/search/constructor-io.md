...
1.  ## Retrieve your Credentials from Constructor
    ...
    **Note:** We assume you already have a working Constructor account. If not, visit the official website and [sign up](https://info.constructor.com/ecommerce-search-discovery-demo) for a plan.
