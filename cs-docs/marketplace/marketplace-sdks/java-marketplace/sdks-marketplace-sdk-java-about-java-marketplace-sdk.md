...
-   **Operation on installation:** Starter Apps can be installed via the Marketplace. Additionally you can [Install Starter via Stack Creation Experience](/docs/marketplace/installing-a-starter#install-starter-via-stack-creation-experience) as well.
