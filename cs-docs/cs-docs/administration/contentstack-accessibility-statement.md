...
description: Contentstack Accessibility Statement
url: https://www.contentstack.com/docs/administration/contentstack-accessibility-statement
...
This page describes Contentstack’s accessibility commitment, its current WCAG conformance status, and the tools and resources referenced for building and validating accessible digital experiences. It is intended for customers, developers, and anyone evaluating or implementing accessibility practices with Contentstack.
...
Contentstack follows the **Web Content Accessibility Guidelines** ([WCAG](https://www.w3.org/WAI/standards-guidelines/wcag/)) to provide an accessible experience for our users. These guidelines define success criteria across three levels of conformance: **A**, **AA**, and **AAA**.
...
For guidance on creating accessible content, refer to the [Authoring Tool Accessibility Guidelines (ATAG) 2.0,](https://www.w3.org/TR/IMPLEMENTING-ATAG20/#part_b) **Section B**.
...
- [VoiceOver](https://support.apple.com/voiceover) for Mac

## Need Help?

If you have any questions or need further assistance regarding accessibility, please reach out to our [support](mailto:support@contentstack.com) team.
...
- [Contentstack Browser Support](/docs/developers/contentstack-basics/what-you-need-to-get-started)**Note**: Devices that exclusively use a touch interface are not supported.

## Common questions

### What WCAG level is Contentstack currently conformant with?
Currently, Contentstack is **partially conformant with WCAG 2.2 Level AA**.

### Does Contentstack enforce front-end accessibility requirements?
While Contentstack does not enforce front-end accessibility requirements at the platform level, our system does not impose any limitations that would prevent full **WCAG 2.2 AAA** compliance if you choose to implement it.

### What tools are recommended for accessibility checking and validation?
- [Axe](https://www.deque.com/axe/) by Deque Systems  
- [WAVE](https://wave.webaim.org/) by WebAIM  
- [Lighthouse](https://developers.google.com/web/tools/lighthouse) by Google

### How can I get help with accessibility questions?
Please reach out to our [support](mailto:support@contentstack.com) team.