...
# [Introduction to Contentstack - a Headless CMS] - Why Should You Choose Contentstack?

This page explains what a headless CMS is, how it differs from traditional and decoupled CMS architectures, and outlines why Contentstack may be a good fit. It is intended for developers, content managers, and teams evaluating CMS options, and should be used when comparing CMS approaches and deciding whether Contentstack fits your content and delivery needs.
...
### What is the difference between traditional, decoupled, and headless CMS?

Traditional CMSs have tightly bound frontend and backend, decoupled CMSs separate frontend and backend components while still having a defined presentation environment, and headless CMSs do not have a frontend layer and deliver content via APIs.

### Who benefits from using Contentstack?

Contentstack benefits both Developers and Content Managers equally.
