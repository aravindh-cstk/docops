...
# [Set Up Your Project] - Transfer Stack Ownership to Other User

This page explains how a stack owner can transfer stack ownership to another user. It is intended for developers or administrators managing stacks and should be used when you need to change the owner of an existing stack.
...
### When does the new owner become the owner of the stack?
As soon as the user accepts the email request, he/she becomes the owner of your stack.

### What access do I have after transferring ownership?
You do not have the rights to make any changes to the stack or to the content within.