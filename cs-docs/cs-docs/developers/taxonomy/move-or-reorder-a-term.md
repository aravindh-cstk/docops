...
## API Reference
To move and reorder terms via API, refer to the [Move/Reorder a Term](/docs/developers/apis/content-management-api#move-reorder-a-term) API request.
...
Yes. Refer to the [Move/Reorder a Term](/docs/developers/apis/content-management-api#move-reorder-a-term) API request.