...
This page explains what Taxonomy is in Contentstack, the key features it provides, and the role-based advantages for different users. It should be read by developers, content managers, and content editors who need to categorize content within a stack for navigation, search, and retrieval, and used when planning or implementing hierarchical content organization and related API operations.
...
### What is Taxonomy used for in Contentstack?
...
### Does Taxonomy support hierarchical organization?
Yes, you can hierarchically organize your web properties based on your requirements, such as their purpose, target audience, or any other aspects of your business.

### Can I manage Taxonomy via API?
Yes. To perform operations related to Taxonomy within your stack via API, refer to the Content Management API and Content Delivery API links provided in the API Reference section.

### Who benefits from using Taxonomy?
Content Managers, Developers, and Content Editors benefit from Taxonomy through improved organization, structured navigation, and more efficient workflows.