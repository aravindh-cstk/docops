...
**Note**: This documentation uses the legacy approach with extensions. We have launched Ace Editor as a Marketplace App. For more information on Ace Editor, please refer to the [Ace Editor App Installation Guide](/docs/developers/marketplace-apps/ace-editor/).

Ace Editor is an embeddable code editor that includes features of native code editors, such as Sublime and Vim.

This step-by-step guide explains how to create an Ace Editor custom field [extension](/docs/developers/about-experience-extensions) for your [content types](/docs/developers/create-content-types/about-content-types) in Contentstack.
...
- On the **Content Type Builder** page, add the [**Custom**](/docs/developers/create-content-types/custom) field to your content type by clicking on the “Insert a field” link denoted by a **+** sign and then on **Custom**.
...
- To use the Ace editor, [create an entry](/docs/content-managers/working-with-entries/create-an-entry) for this content type, and you will see the this field on your entry page as shown below:

**Additional Resource:** You can also refer to our guide on adding the [JSON editor](/docs/developers/create-custom-fields/use-prebuilt-custom-fields/json-editor) to your stack, which allows users to input JSON data as normal "text,” “code,” “tree” format, “form,” and “view.”

## Common questions

**Q: Is this guide for the Marketplace App version of Ace Editor?**  
A: No. **Note**: This documentation uses the legacy approach with extensions. We have launched Ace Editor as a Marketplace App. For more information on Ace Editor, please refer to the [Ace Editor App Installation Guide](/docs/developers/marketplace-apps/ace-editor/).

**Q: Where do I select the Ace Editor extension when building a content type?**  
A: Select **Ace Editor** from the **Select Extension** dropdown menu after adding the [**Custom**](/docs/developers/create-content-types/custom) field in the **Content Type Builder**.
...
A: Yes. **Note**: You can provide specific instance-level configuration settings for your Custom Field extension by referring to the [Config parameters](/docs/developers/create-content-types/config-parameter-for-custom-fields-only) section.