---
title: "[JavaScript Delivery] - About JavaScript Delivery SDK"
description: About the Contentstack JavaScript Delivery SDK for fetching content via Content Delivery APIs and using it in JavaScript-based applications.
url: https://www.contentstack.com/docs/developers/sdks/content-delivery-sdk/javascript-browser/about-javascript-delivery-sdk
...
# [JavaScript Delivery] - About JavaScript Delivery SDK

This page explains what the Contentstack JavaScript Delivery SDK is, what it’s used for, and where to go next (getting started steps, sample apps, and the GitHub repository). It’s intended for developers integrating Contentstack content into JavaScript applications and deciding between the JavaScript and TypeScript Delivery SDKs.
