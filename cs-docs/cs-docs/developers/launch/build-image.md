...
url: https://www.contentstack.com/docs/developers/launch/build-image
...
Refer to the [Supported Node.js Versions on Launch](/docs/developers/launch/supported-nodejs-versions/) documentation.
