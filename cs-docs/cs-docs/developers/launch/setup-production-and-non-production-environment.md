...
- You can add a custom domain for your projects. To do this, click **Domains** and then the **+ New Domain** button, to [add a custom domain](/docs/launch/custom-domain).
...
Yes. The production environment steps include adding a custom domain via **Domains** and **+ New Domain**, linking to [add a custom domain](/docs/launch/custom-domain).