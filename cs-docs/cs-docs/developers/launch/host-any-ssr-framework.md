...
Follow the steps mentioned in the [Other Frameworks on Launch](/docs/launch/other-frameworks-on-launch#hosting-an-ssr-framework-site) guide.

### Which SSR frameworks are officially supported by Launch?
Examples of officially supported SSR frameworks include [NextJS](/docs/launch/nextjs-on-launch/), [Gatsby](/docs/launch/gatsby-on-launch/), and [Angular-SSR](/docs/launch/angular-on-launch#server-side-rendering-ssr).