...
The base branch serves as the basis for comparison and also the location where any changes would be merged into (see [Merging Branches](/docs/developers/branches/merging-branches) for more information). The compare branch contains the changes you want to merge.

**Note**: The Compare feature is currently available only for the content type and global field modules and is accessible through [Content Management API](/docs/developers/apis/content-management-api/#comparing-branches) and [CLI commands](/docs/developers/cli/compare-and-merge-branches-using-the-cli/).
...
**Additional Resource:** To learn how to compare branches using our new request in the [Comparing Branches](/docs/developers/apis/content-management-api/#comparing-branches) section in CMA, refer to our documentation. To compare branches via CLI, you can refer to the [Compare Branches](/docs/developers/cli/compare-and-merge-branches-using-the-cli/#steps-to-compare-branches) section in the guide on how to [Compare and Merge Branches using the CLI](/docs/developers/cli/compare-and-merge-branches-using-the-cli/).
...
Next, you can make changes to the Blog content type within the development branch. Once you are satisfied with your changes, you can quickly check the differences between the development (compare) branch and the main (base) branch using Branch Compare [CMA requests](/docs/developers/apis/content-management-api/#comparing-branches) or [CLI commands](/docs/developers/cli/compare-and-merge-branches-using-the-cli/).
...
**Additional Resource:** Once you are satisfied with the development changes between your branches, you can merge them. Learn more about [Merging Branches](/docs/developers/branches/merging-branches).

## Common questions

### Where is the Branch Compare feature available?
The Compare feature is currently available only for the content type and global field modules and is accessible through [Content Management API](/docs/developers/apis/content-management-api/#comparing-branches) and [CLI commands](/docs/developers/cli/compare-and-merge-branches-using-the-cli/).
...
Use Branch Compare when you want to quickly check the differences between the development (compare) branch and the main (base) branch using Branch Compare [CMA requests](/docs/developers/apis/content-management-api/#comparing-branches) or [CLI commands](/docs/developers/cli/compare-and-merge-branches-using-the-cli/).

### What should I do after comparing branches?
Once you are satisfied with the development changes between your branches, you can merge them. Learn more about [Merging Branches](/docs/developers/branches/merging-branches).