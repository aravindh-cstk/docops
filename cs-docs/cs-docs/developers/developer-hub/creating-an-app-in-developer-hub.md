...
url: https://www.contentstack.com/docs/developers/developer-hub/creating-an-app-in-developer-hub
...
**App Type (required):** Select the type of app you want to create: Organization or Stack. Read more about [Types of App](/docs/developers/developer-hub/types-of-apps/).
...
- On the left navigation panel, you will find [OAuth](/docs/developers/developer-hub/contentstack-oauth), [UI Locations](/docs/developers/developer-hub#managing-ui-locations), [Webhooks](/docs/developers/developer-hub/managing-webhooks-in-an-app), [Hosting](/docs/developers/developer-hub/app-hosting), App [Manifest](/docs/developers/developer-hub/app-manifest), and [Version Log](/docs/developers/developer-hub/app-versioning/) options.By using the **App Manifest **and **Version **options, you can view the current and previous versions of the app, whereas the remaining options let you configure or define the app.
...
On the left navigation panel, you will find [OAuth](/docs/developers/developer-hub/contentstack-oauth), [UI Locations](/docs/developers/developer-hub#managing-ui-locations), [Webhooks](/docs/developers/developer-hub/managing-webhooks-in-an-app), [Hosting](/docs/developers/developer-hub/app-hosting), App [Manifest](/docs/developers/developer-hub/app-manifest), and [Version Log](/docs/developers/developer-hub/app-versioning/) options.

### Where can I read more about application categories?
For more information about the different application categories, please refer to the "[Introduction to Contentstack Applications.](/docs/developers/developer-hub/introduction-to-contentstack-applications)"
