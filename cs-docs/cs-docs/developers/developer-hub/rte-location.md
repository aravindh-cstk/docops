...
url: https://www.contentstack.com/docs/developer-hub/rte-location
...
The RTE Location lets you add/ create custom plugins to extend the functionality of your[JSON Rich Text Editor](../json-rich-text-editor/about-json-rich-text-editor.md) as per your needs.
...
You can create new RTE locations by writing your custom code, or you can use the prebuilt [boilerplate](./marketplace-app-boilerplate.md) and modify the given code to suit your requirements.
