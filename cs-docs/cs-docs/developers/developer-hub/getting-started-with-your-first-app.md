...
- [Apps CLI Plugin](/docs/developers/cli/apps-cli-plugin) configured for Contentstack CLI
- Understanding of [App SDK](https://github.com/contentstack/app-sdk-docs)
- Understanding of React.js
- [Venus Component Library](/docs/developers/venus-component-library/) installed on your machine
