...
The page mentions [Hosting with Launch](/docs/developer-hub/app-hosting#hosting-with-launch) and [Custom Hosting](/docs/developer-hub/app-hosting#custom-hosting).
