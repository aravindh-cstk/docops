...
The Dashboard Location is a type of location that lets you create widgets for your[stack dashboard](/docs/developers/set-up-stack/about-stack-dashboard).
...
Contentstack also allows you to [customize your dashboard view](/docs/developers/set-up-stack/customize-your-dashboard-view) and arrange widgets as per your requirements.
