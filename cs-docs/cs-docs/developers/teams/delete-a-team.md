...
**Note**: Only the [Owner](/docs/developers/organization/organization-roles#organization-owner) or [Admin](/docs/developers/organization/organization-roles#organization-admin) of the organization can delete teams created by other stakeholders.

To delete a team, log in to your [Contentstack account](https://www.contentstack.com/login), and perform the following steps:
- Go to your [Organization](/docs/developers/organization/about-organizations) where you want to delete an existing team, navigate to the “Org Admin” icon on the left navigation panel, and select **Teams **from the menu.
...
**Additional Resource**: You can also delete teams via the [Delete a team](/docs/developers/apis/content-management-api#delete-a-team) API request.

## Common questions

### Who can delete a team?
Only the [Owner](/docs/developers/organization/organization-roles#organization-owner) or [Admin](/docs/developers/organization/organization-roles#organization-admin) of the organization can delete teams created by other stakeholders.
...
Yes. You can also delete teams via the [Delete a team](/docs/developers/apis/content-management-api#delete-a-team) API request.