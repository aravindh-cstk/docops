...
# [Marketplace guides and apps] - Introduction to Contentstack Starters

This page introduces Contentstack Starters available in the Contentstack Marketplace, explains what they are used for, and lists the technologies used to build them. It is intended for developers and beginners who want to quickly install a starter app and learn how to build websites using Contentstack.

## Introduction to Contentstack Starters

Starters in Marketplace are designed to help beginners learn how to build websites using Contentstack.
...
**Q: Where do I find Starters in Contentstack?**  
A: Navigate to the [Starters](https://app.contentstack.com/#!/marketplace/starters) section in Contentstack Marketplace and select the app that you want to install.

**Q: What technologies are used to build Contentstack Starters?**  
