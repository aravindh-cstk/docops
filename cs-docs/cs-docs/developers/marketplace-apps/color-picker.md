...
# [Marketplace guides and apps] - Color Picker App Installation Guide

This page explains how to install and configure the Contentstack Color Picker app from the Marketplace and how to use it within your stack. It is intended for Contentstack users with Owner/Admin access who want to add a Color Picker custom field to content types and entries.
...
## Steps for Execution
- [Install and Configure Color Picker in Contentstack Marketplace](#install-and-configure-color-picker-in-contentstack-marketplace)
- [Use Color Picker within your Stack](#use-color-picker-within-your-stack)
...
### Do I need additional configuration to use the Color Picker app?
No additional configuration is required to use the Color Picker app.

### What permissions do I need to install the Color Picker app?
Access to the Contentstack Organization/Stack as the Owner/Admin.

### Where do I enable or disable the app’s UI locations?
On the **UI Locations** tab, you can use the toggle button corresponding to each UI location to enable or disable it based on your requirements.

### How do I use the Color Picker in an entry?
Add **Color Picker** under **Select Extension/App** in a Custom field for a content type, then create an entry for that content type and use the Color Picker custom field on the entry page.