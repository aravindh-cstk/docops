---
title: "[Extensions] - Use Asset Sidebar Extensions"
description: How to use an Asset Sidebar Extension in a Contentstack stack to manage, transform, and optimize assets.
url: https://www.contentstack.com/docs/developers/create-asset-sidebar-extensions/use-asset-sidebar-extensions
...
# [Extensions] - Use Asset Sidebar Extensions

This page explains how to use Asset Sidebar Extensions in Contentstack to manage, transform, and optimize assets. It is intended for developers or stack users who have already added an Asset Sidebar Extension and want to apply it to assets via the Contentstack UI.
...
### What should I do after using the widget?
Once done using the widget, **Save** the asset details.