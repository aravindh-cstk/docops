...
# [Contentstack Command-line Interface (CLI)] - Bootstrap Starter Apps

This page explains how to use the Contentstack CLI Bootstrap plugin and the `cm:bootstrap` command to set up Starter apps by cloning a project, creating or selecting a stack, and importing required content. It is intended for developers who want to automate Starter app setup and then run or deploy the app.
...
# REACT_APP_CONTENTSTACK_APP_HOST=au-api.contentstack.com
...
### Which Starter apps are supported?
See the **Supported Starter Apps** section for the list of supported Starter apps.