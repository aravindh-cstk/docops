...
Yes. Currently, you cannot import content for the following modules:[Roles](/docs/developers/invite-users-and-assign-roles/about-stack-roles), [Users](/docs/developers/invite-users-and-assign-roles/about-stack-users), and [Releases](/docs/content-managers/create-and-manage-releases/about-releases).