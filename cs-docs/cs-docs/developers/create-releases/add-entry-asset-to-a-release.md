...
After creating a [release](../../content-managers/create-and-manage-releases/about-releases.md), you can start adding entries or assets to it.

**Additional Resource**: You can now [bulk add multiple entries](../../content-managers/author-content/bulk-add-to-release.md) to a release.
...
1. Navigate to the desired [stack](../set-up-stack/about-stack.md), then click the “Entries” or “Assets” icon on the left navigation panel and select an existing entry or asset.
...
3. In the **Add to Release** modal, either select an existing release or create a new one.![Add Entry_Asset to a Release_2.png](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/blt8b46a06295fb0ff0/66f25b1705ba5bd98720dff9/Add_Entry_Asset_to_a_Release_2.png)
   ...
   **Note**: For older releases, you may receive a warning message indicating that references will not be included, or that only one level of nesting is published/unpublished for single items. To avoid this, [create](../../content-managers/create-and-manage-releases/create-a-new-release.md) a new release or [clone](../../content-managers/create-and-manage-releases/clone-a-release.md) the older release.
   ...
   2. Select **Add with References** to include all referenced entries or **Add without References** to add only the selected entry.
      ...
      **Note**: You can view the release action logs in the [Stack Bulk Task Queue](../../content-managers/author-content/stack-bulk-task-queue.md).

After successfully adding items to a release, you can [deploy](../../content-managers/create-and-manage-releases/deploy-a-release.md) the release to an environment.

**Note**: You can update the release items to their latest versions before you deploy the release. Refer to our [Update Release items to their Latest Versions](../../content-managers/create-and-manage-releases/update-release-items-to-their-latest-versions.md) documentation for more information.

### API Reference

To add entries or assets to a release via API, refer to the [Add a single item to a Release](../../../api-docs/api-detail/content-management-api.md#add-a-single-item-to-a-release) and [Add multiple items to a Release](../../../api-docs/api-detail/content-management-api.md#add-multiple-items-to-a-release) API requests.
