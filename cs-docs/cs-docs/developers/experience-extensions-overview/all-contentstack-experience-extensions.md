---
title: Experience Extensions Overview - All Contentstack Experience Extensions
description: Overview of Contentstack Experience Extensions and related integrations, including Field, Sidebar, and Dashboard extensions.
url: https://www.contentstack.com/docs/developers/experience-extensions-overview/all-contentstack-experience-extensions
...
# Experience Extensions Overview - All Contentstack Experience Extensions
...
Get more from your Contentstack data by integrating with third-party apps such as Swiftype, Google Analytics, Optimizely, and more.

- [Swiftype Search](/docs/developers/integrations/swiftype-search) - Swiftype helps you add search to your Contentstack-powered websites.
- Google Analytics via GTM - Google Tag Manager (GTM) will help you integrate website tags with snippets of code that sit within the code of a web page and enable you to track, analyze, and create reports of your web page.
...
- [AWS SQS](/docs/developers/how-to-guides/manage-webhook-events-in-a-messageq-system-using-aws-sqs): Use AWS SQS to create a message queuing system using Contentstack Webhook and AWS Lambda to automate a series of actions.
- [Algolia Search](/docs/developers/how-to-guides/add-algolia-search-to-contentstack-powered-websites-using-aws-lambda): Implement Algolia on top of your Contentstack-powered websites.
- [Lucidworks Search](/docs/developers/how-to-guides/add-lucidworks-search-to-contentstack-powered-websites): Implement Lucidworks search on top of your Contentstack-powered websites.
- [Elasticsearch](/docs/developers/how-to-guides/add-elasticsearch-to-contentstack-powered-websites): Implement Elasticsearch on top of your Contentstack-powered websites.
- [AWS Amplify](/docs/developers/how-to-guides/deploy-contentstack-powered-website-on-aws-amplify): Deploy Contentstack Powered Website on AWS Amplify
- [Uniform](/docs/developers/how-to-guides/personalize-your-contentstack-powered-website-using-uniform-optimize): Personalize your Contentstack-powered website using Uniform Optimize.
...
**Q: What are Sidebar Experience Extensions used for?**  
A: Use Contentstack's Sidebar Experience Extensions that help you analyze the entry's content and get content recommendations using third-party APIs.

**Q: What are Dashboard Extensions used for?**  
A: Use Contentstack's Dashboard Extensions that let you create extensions for the stack Dashboard.