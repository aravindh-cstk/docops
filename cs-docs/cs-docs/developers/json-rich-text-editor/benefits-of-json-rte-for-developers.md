...
# [Json Rich Text Editor] - Benefits of JSON RTE for Developers

This page explains the benefits of using a JSON Rich Text Editor (JSON RTE) from a developer perspective, especially when building multi-channel experiences and integrating structured content into frontend frameworks and APIs. Developers and technical teams should use this when evaluating or implementing JSON RTE-based content models, rendering pipelines, serialization, and headless CMS workflows.
...
### Who should use JSON RTE?

Developers and technical teams who need structured content that can be rendered across multiple channels and integrated into frontend frameworks and APIs should use JSON RTE.

### How does JSON RTE help with multi-channel delivery?

JSON RTE provides structured content independent of any presentation layer, allowing developers to render content across web applications, mobile apps, smart devices, kiosks, and chat interfaces.

### Can JSON RTE content be converted into other formats?

Yes. Developers can convert JSON-formatted content into HTML, Markdown, plain text, or other formats using the JSON RTE Serializer.

### Why is JSON RTE safer than raw HTML?

The JSON format reduces the risk of cross-site scripting (XSS) attacks compared to raw HTML and allows for effective content sanitization and reliable validation processes.