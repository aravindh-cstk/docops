...
If you have the required permissions, you can add languages to your [stack](../set-up-stack/about-stack.md) to create and publish [entries](../../content-managers/author-content/about-entries.md) in multiple languages.
...
For example, you are working within the development branch, and you add new languages such as German and Chinese to this branch. These languages will be available only within the development branch.
 Refer to our [Branch-specific Modules](../branches/branch-specific-modules.md) document for more information.

You can either add a language from our [list of supported languages](./list-of-supported-languages.md) or [create a custom language](./add-a-custom-language.md) of your choice.
...
To add a language in your stack via API request, refer to [Add a language](../../../api-docs/api-detail/content-management-api.md#add-a-language) API request.

After adding the language in the stack, the [content manager](../invite-users-and-assign-roles/types-of-roles.md#content-manager) can add an entry in the specified language or create [localized entries](./about-localization.md).

**Note**: The Content Manager can view or create content in multiple languages only for the languages that are added to the stack by the [Admin](../invite-users-and-assign-roles/types-of-roles.md#admin)/[Developer](../invite-users-and-assign-roles/types-of-roles.md#developer).
...
Refer to the [Add a language](../../../api-docs/api-detail/content-management-api.md#add-a-language) API request.