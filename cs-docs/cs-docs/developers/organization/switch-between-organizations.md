...
This page explains how to switch between organizations in Contentstack so you can access and manage stacks across multiple organizations. It is intended for Contentstack users who are members of more than one organization and need to move between them during day-to-day work.
...
### What changes after I switch organizations?
After switching, you can view the stacks for the selected organization.

### How do I switch organizations using the old navigation?
Click the “Organization” tab in the header and select the organization you want to access.