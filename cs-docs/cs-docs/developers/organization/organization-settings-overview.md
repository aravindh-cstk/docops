...
# [Organization] - Organization Settings Overview

This page explains what the **Organization Settings** page is, who can access it, and how to navigate to it in Contentstack. It is intended for Organization **Owner** and **Admin** users who need to view or manage organization-level settings.
...
**What can I manage from Organization Settings?**  
Organization Owners/Admins can access Organization Information, Product Analytics, Organization Users, and Organization Stacks from this section.