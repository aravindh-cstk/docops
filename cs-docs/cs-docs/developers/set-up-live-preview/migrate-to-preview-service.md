...
The **Preview Service** enhances performance by offering faster load times and improved efficiency compared to the [Content Management API (CMA)](../../../api-docs/api-detail/content-management-api.md). This guide walks you through the migration process from the CMA to the Preview Service.

## Prerequisites
- Access to a Contentstack [stack](../set-up-stack/about-stack.md) with [Live Preview](../../content-managers/author-content/about-live-preview.md) enabled
- [Preview token](../create-tokens/about-delivery-tokens.md#understanding-preview-tokens) (instead of a management token)
...
**Note: **For region-specific base URLs, refer to the [Preview API](../set-up-timeline/preview-api.md) documentation.
- #### Update API Token
...
**Note: **This example uses the REST Preview Service. To use the GraphQL Preview service, refer to:[Set Up Live Preview with GraphQL for SSR](./set-up-live-preview-with-graphql-for-server-side-rendering.md)
- [Set Up Live Preview with GraphQL for CSR](./set-up-live-preview-with-graphql-for-client-side-rendering.md)

**Additional Resource**: For more information on Live Preview, refer to [About Live Preview](../../content-managers/author-content/about-live-preview.md) to understand its benefits and functionality, or follow [Set up Live Preview for your Website](./set-up-live-preview-for-your-website.md) for a step-by-step configuration guide.

## Common questions

### Do I need a management token to use the Preview Service?
No. Use a [Preview token](../create-tokens/about-delivery-tokens.md#understanding-preview-tokens) (instead of a management token).
...
Refer to the [Preview API](../set-up-timeline/preview-api.md) documentation.