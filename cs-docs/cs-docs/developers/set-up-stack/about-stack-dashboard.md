...
# [Set Up Your Project] - About Stack Dashboards

This page explains what Stack Dashboards are in Contentstack, what they show by default, and how users can customize the dashboard using widgets and extensions. It is intended for Contentstack users and developers who want to navigate recent stack activity or extend the dashboard experience.
...
To access the dashboard (press “D”), you simply need to log in to your [Contentstack account](/login).
...
### Can I sort or hide widgets for everyone?
**Note**: Any sorting/hiding task you perform on the dashboard will be visible to you only.

### How do I access the dashboard quickly?
To access the dashboard (press “D”), you simply need to log in to your [Contentstack account](/login).