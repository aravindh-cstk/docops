...
# [Get Started with CS] - Build and Integrate with Contentstack

This page introduces how to build and integrate with Contentstack by using integrations, marketplace apps, and developer resources. It is intended for developers and teams looking to extend the Contentstack UI, connect third-party services, and customize CMS functionality.

## Build and Integrate with Contentstack

Integrate third-party applications to enrich your Contentstack UI and suit your business requirements. Learn how to integrate and build apps and extensions to customize the look of your account.

## Integrations

Effortlessly integrate your favorite third-party apps with Contentstack, allowing you to connect in custom functionalities and make the best use of the CMS. You can easily set up any integrations and use them within your organization or stacks.

Learn more about [Integrations](/docs/developers/integrations/).
...
To find entry points for integrating third-party services and building or installing apps and extensions in Contentstack.

### Where do I go to install ready-to-use apps?
Use the Marketplace resources linked under Marketplace Guides and Marketplace Apps.

### Where do I start if I want to build my own app?
Start with the Developer Hub, which provides app development APIs, SDKs, and other resources.

### What are app boilerplates used for?
They provide pre-configured settings and essential functionalities to streamline custom application development.