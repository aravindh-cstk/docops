---
title: "[Author Content] - Reply to a Comment"
description: Reply to a comment within content entries to engage in collaborative discussions and manage feedback.
url: https://www.contentstack.com/docs/content-managers/author-content/reply-to-a-comment
...
# [Author Content] - Reply to a Comment

This page explains how content managers can reply to comments inside Contentstack entries to collaborate during reviews, address feedback, and continue discussions while updating content.
...
**How long can my reply comment be?**  
The maximum length of a comment is **500 characters**.

**Where do I find the Entries section to reply to comments?**  
