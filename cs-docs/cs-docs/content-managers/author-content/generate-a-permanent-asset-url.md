...
- [Generate permanent asset URL](/docs/developers/apis/content-management-api#generate-permanent-asset-url)
- [Download an asset with permanent URL](/docs/developers/apis/content-management-api#download-an-asset-with-permanent-url)
