...
**Tip:** For efficiency, you can [delete entries in bulk](/docs/content-managers/author-content/bulk-delete-entries/).

**Additional Resource:** To delete specific entry variants, refer to our [Delete an Entry Variant](/docs/content-managers/entry-variants/delete-an-entry-variant) document.

## API Reference

To delete an entry via API request, refer to the [Delete an entry](/docs/developers/apis/content-management-api#delete-an-entry) API request.
...
A: Refer to the [Delete an entry](/docs/developers/apis/content-management-api#delete-an-entry) API request.