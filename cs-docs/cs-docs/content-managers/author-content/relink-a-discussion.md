...
- **Marking fields as "Multiple" or reverting them to "Single":** Fields such as “[Group](../../developers/create-content-types/group.md),” “[Modular Blocks](../../developers/create-content-types/modular-blocks.md),” or “[Global](../../developers/global-field/about-global-field.md)” are made up of multiple subfields, and you can create discussions for each subfield. However, when you change the parent field to “[Multiple](../../developers/create-content-types/multiple.md),” the discussion loses track of the subfield it was linked to. The same issue occurs when you change a parent field from "Multiple" back to "Single".**Note:** You can add comments only to the primitive subfields within “Group,” “Modular Blocks,” or “Global” fields, such as “Boolean,” “Select,” “Link,” “Single Line Textbox,” “Multiline Textbox,” and so on.
