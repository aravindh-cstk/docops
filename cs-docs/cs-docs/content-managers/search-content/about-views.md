...
# [Search Content] - About Views

This page explains how the **Views** feature in Contentstack Search Content helps content managers and teams quickly find and manage entries and assets using predefined and customizable views. Read this when you want to understand available view types (Popular, Saved, and Content Type Views) and how to use them to streamline navigation and search.
...
Whether you're managing entries or assets, Views streamline the process, helping you focus on your content.

**Note:** All your previous saved searches have been moved under Saved Views.

## Common questions

### Where can I find my previously saved searches?
All your previous saved searches have been moved under **Saved Views**.

### What’s the difference between Popular Views and Saved Views?
**Popular Views** are predefined views tailored to common search scenarios, while **Saved Views** are customized views you save after applying filters and advanced queries.

### Can I create entries from the Views area?
