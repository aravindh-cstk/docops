...
# [Search Content] - About Search

This page explains Contentstack’s Search functionality for content managers who need to find assets or entries within a stack. Use it when you want to understand where Search is available in the app and what search options (Quick Search, Filters, Advanced Search, and Views) are supported.
...
### Where can I access the Search bar in Contentstack?
