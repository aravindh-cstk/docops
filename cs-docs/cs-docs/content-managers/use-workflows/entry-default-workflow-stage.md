...
# [Use Workflows] - Entry Default Workflow Stage

This page explains what the entry default workflow stage is, what happens when you create and save a new entry, and how assignments and due dates behave for the first workflow stage. It is intended for content managers working with entries and workflows, and should be used when you need to understand or manage the initial workflow state of an entry.
