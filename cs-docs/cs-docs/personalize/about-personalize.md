---
title: "[Personalize] - About Personalize"
description: Overview of Contentstack Personalize and how to access it from the Contentstack app switcher.
url: https://www.contentstack.com/docs/personalize/about-personalize
...
# [Personalize] - About Personalize

This page introduces Contentstack Personalize, explains what it does, and outlines how to access it from your Contentstack account to start creating Personalize projects and experiences.
...
To access Personalize, log in to your [Contentstack account](https://www.contentstack.com/login/).

In the top navigation bar, click the **App Switcher** icon and then click **Personalize**.You can then create a new Personalize project by clicking the **+ New Personalize Project** button.

Your Personalize landing page will look as follows:

## Tutorial Video

## Common questions

### How do I enable Personalize for my organization?
To enable Personalize for your organization, reach out to the [support](mailto:support@contentstack.com) team.

### Where do I access Personalize in Contentstack?
