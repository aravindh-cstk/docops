...
-   For a single entry, use the rollback option within the entry editor. Refer to the [Publish an Entry](/docs/headless-cms/publish-an-entry) document.
-   For a bulk publish, use the rollback option in the Publish Queue. Refer to the [Bulk Publish](/docs/headless-cms/bulk-publish-entries) and [Publish Queue](/docs/headless-cms/view-publish-status-of-entries-assets-in-publish-queue) document.
