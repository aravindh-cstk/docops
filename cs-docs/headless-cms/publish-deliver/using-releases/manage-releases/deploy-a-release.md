...
To deploy a release, sign in to your [Contentstack account](https://www.contentstack.com/login) and follow these steps:
...
3. In the **Deploy Release** window, you get the following options.
