...
-   To publish every entry in the list in one action, refer to [Select All Records](/docs/headless-cms/select-all-records-for-bulk-operations) for Bulk Operations on Entries.
