...
2.  Use the checkboxes to select the entries you want to publish. To publish every entry in the list instead of only the entries on the current page, use [select all records](/docs/headless-cms/select-all-records-for-bulk-operations).
...
-   You can select and publish up to **100 entries** at a time in **10 languages** across **10 environments**. To publish a larger set in one action, use [select all records](/docs/headless-cms/select-all-records-for-bulk-operations), which publishes up to **10,000 entries** in one action.
...
-   To publish every entry in the list in one action, refer to [Select All Records for Bulk Operations on Entries](/docs/headless-cms/select-all-records-for-bulk-operations).
