...
To publish an entry, sign in to your [Contentstack account](https://www.contentstack.com/login/) and perform the following steps:
...
6. Under the **Publish** section, select one of the following options.
 ...
 **Tip:** Asset rows are displayed as system assets.
