...
url: /headless-cms/support-troubleshooting/headless-cms-troubleshooting-guides/10-cma-behavior-limits-miscellaneous/16-no-historical-publish-status-per-entry-version
doc_type: faq
