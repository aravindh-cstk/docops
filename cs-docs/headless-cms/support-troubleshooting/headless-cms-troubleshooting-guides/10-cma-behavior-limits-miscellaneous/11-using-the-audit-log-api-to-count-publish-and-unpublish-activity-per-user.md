...
url: /headless-cms/support-troubleshooting/headless-cms-troubleshooting-guides/10-cma-behavior-limits-miscellaneous/11-using-the-audit-log-api-to-count-publish-and-unpublish-activity-per-user
doc_type: faq
