...
url: /headless-cms/support-troubleshooting/headless-cms-troubleshooting-guides/06-authentication-tokens-access/01-api-user-session-breaks-when-using-two-factor-authentication
doc_type: faq
