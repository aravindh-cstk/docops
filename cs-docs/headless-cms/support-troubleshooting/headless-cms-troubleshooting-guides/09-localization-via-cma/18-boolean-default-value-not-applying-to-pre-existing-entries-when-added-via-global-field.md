...
url: /headless-cms/support-troubleshooting/headless-cms-troubleshooting-guides/09-localization-via-cma/18-boolean-default-value-not-applying-to-pre-existing-entries-when-added-via-global-field
doc_type: faq
