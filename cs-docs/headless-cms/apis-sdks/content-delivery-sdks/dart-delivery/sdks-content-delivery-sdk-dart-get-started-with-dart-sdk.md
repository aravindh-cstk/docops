...
For Europe, Azure North America, or Azure Europe, check the [code of your region](/docs/administration/selecting-region-in-sdks#dart) and configure your SDK.  

Once you have initialized the SDK, you can query entries to fetch the required content.

For setting the branch for Europe, Azure North America, or Azure Europe, check the [code of your region](/docs/administration/selecting-region-in-sdks#dart) and initialize SDK in a particular branch.
...
These were examples of some of the basic queries of the SDK. For advanced queries, refer to Contentstack [Dart SDK API Reference](/docs/developers/sdks/content-delivery-sdk/dart/reference/) documentation.
