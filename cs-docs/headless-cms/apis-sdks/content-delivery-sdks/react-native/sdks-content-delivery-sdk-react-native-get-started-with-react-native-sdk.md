...
<span>const Stack = new Contentstack({ ‘api_key’: “stack_api_key”, ‘access_token’: “delivery_token”, ‘environment’: “environment_name”, “region”: Contentstack.Region.AZURE_NA}) //For Azure NA<br></span><span>const Stack = new Contentstack({ ‘api_key’: “stack_api_key”, ‘access_token’: “delivery_token”, ‘environment’: “environment_name”, “region”:<span>&nbsp;</span></span><span>Contentstack.Region.AZURE_EU</span><span>}) //For Azure EU</span>
```
...
To get a single [entry](/docs/headless-cms/about-entries/), specify the [content type](/docs/headless-cms/about-content-types) and the id of the entry.
