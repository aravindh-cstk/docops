...
```
stack.syncPaginationToken( < pagination_token > , completion: {
    (syncStack: SyncStack, error: NSError) in
    //error for any error description
    //syncStack for SyncStack 
    //syncStack.syncToken: contains token for next sync Store this token for next sync
...
```
stack.syncToken( < sync_token > , completion: {
    (syncStack: SyncStack, error: NSError) in
    //error for any error description
    //syncStack for SyncStack 
    //syncStack.syncToken: contains token for next sync Store this token for next sync
...
```
stack.sync(from: < start_date > , completion: {
    (syncStack: SyncStack, error: NSError) in
    //error for any error description
    //syncStack for SyncStack 
    //syncStack.syncToken: contains token for next sync Store this token For next sync
...
```
[stack syncFrom: < start_date > completion: ^ (SyncStack * _Nullable syncStack, NSError * _Nullable error) {
    //error for any error description
    //syncStack for SyncStack 
    //syncStack.syncToken: contains token for next sync Store this token For next sync
    //syncStack.paginationToken: contains token for next sync page this token for next sync
...
```
stack.syncOnly( < content_type_id > , completion: {
    (syncStack: SyncStack, error: NSError) in
    //error for any error description
    //syncStack for SyncStack 
    //syncStack.syncToken: contains token for next sync Store this token For next sync
...
```
[stack syncOnly: < content_type_id > completion: ^ (SyncStack * _Nullable syncStack, NSError * _Nullable error) {
    //error for any error description
    //syncStack for SyncStack 
    //syncStack.syncToken: contains token for next sync Store this token For next sync
    //syncStack.paginationToken: contains token for next sync page this token for next sync
...
You can also initialize sync with entries and assets based on a specific publish type. The acceptable values are ENTRY\_PUBLISHED, ENTRY\_UNPUBLISHED, ENTRY\_DELETED, ASSET\_PUBLISHED, ASSET\_UNPUBLISHED, ASSET\_DELETED, and CONTENT\_TYPE\_DELETED. To do this, use syncPublishType and specify the parameters.
...
```
stack.syncOnly( < content_type_id > , locale: ENGLISH_UNITED_STATES , from: < start_date > , publishType:ENTRY_PUBLISHED , completion: {
    (syncStack: SyncStack, error: NSError) in
    //error for any error description
    //syncStack for SyncStack 
    //syncStack.syncToken: contains token for next sync Store this token For next sync
...
```
[stack syncOnly: < content_type_id > locale: ENGLISH_UNITED_STATES from: < start_date > publishType:ENTRY_PUBLISHED completion: ^ (SyncStack * _Nullable syncStack, NSError * _Nullable error) {
    //error for any error description
    //syncStack for SyncStack 
    //syncStack.syncToken: contains token for next sync Store this token For next sync
    //syncStack.paginationToken: contains token for next sync page this token for next sync
