...
_A Headless CMS shares almost all of the benefits provided by the Decoupled CMS._
...
If you are already using a CMS such as WordPress or Drupal, you can migrate your content to Contentstack. Refer our [Content Migration](/docs/headless-cms/set-up-content-migration-framework-macos) docs for a detailed step-by-step process on how to get started with Contentstack.
