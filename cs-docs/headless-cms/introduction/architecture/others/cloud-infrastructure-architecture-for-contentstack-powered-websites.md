...
This diagram outlines the architecture details of a [simple](/docs/headless-cms/simple-website-detailed-architecture) or [dynamic](/docs/headless-cms/dynamic-website-detailed-architecture) website that uses Amazon Web Services (AWS) as its cloud infrastructure provider. It explains the various components of your infrastructure and highlights how the client interacts with your app, and how your app communicates with the third-party services.  

![Cloud_Infrastructure_Diagram.jpg](https://images.contentstack.io/v3/assets/blt23180bf2502c7444/blt024eb4485ba5b61f/638709129743b810a4de8383/Cloud_Infrastructure_Diagram.jpg)
...
1.  Developer deploying the code
2.  Regular user consuming the content
3.  Contentstack app accessing the infrastructure
