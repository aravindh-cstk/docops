...
![Simple_Wesbite_Using_DataSync-02.svg](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/blt16345bc63ca195d5/63ea4b38167c064eec4b401a/Simple_Wesbite_Using_DataSync-02.jpg)
...
This diagram explains the architecture that you would need to set up a simple site using [DataSync](/docs/headless-cms/about-contentstack-datasync). The DataSync utility allows you to store your Contentstack data in your local database, thus reducing API calls to the Contentstack server.
...
**Marketo Forms** is a SaaS provider that helps you create marketing forms (for product campaigns, etc.) for your website. Contentstack allows you to embed Marketo Forms in entries via a [custom field extension](/docs/developer-hub/custom-field-location). So whenever you create an entry in Contentstack, you’ll have the provision to select a form from several available form options and add it to your entry. Later, when the page loads on your frontend page, the forms load through the embedded code. 

**Google Analytics** lets you analyze the performance of your website. Contentstack enables you to view Google Analytics data directly in your stack via a [custom widget](/docs/developer-hub/sidebar-location) or [dashboard widget](/docs/developer-hub/dashboard-location). You’ll get detailed analytics through a custom widget - user behavior, page load time, page views, etc. - of your specific entry within the entry page. You can get your website’s overall analytics on your Contentstack’s stack dashboard through the dashboard widget.
...
-   [How to start using Contentstack](/docs/headless-cms/how-to-start-using-contentstack)[  
    ](/docs/headless-cms/get-started-with-contentstack-datasync)
-   [Contentstack DataSync](/docs/headless-cms/get-started-with-contentstack-datasync)
