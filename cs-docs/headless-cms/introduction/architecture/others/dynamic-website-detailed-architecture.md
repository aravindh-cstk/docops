...
![Dynamic_Website_-_Detailed_Arhitecture.jpg](https://images.contentstack.io/v3/assets/blt23180bf2502c7444/blt9421b607467c8ae4/638708659405fa1010ee9e2f/Dynamic_Website_-_Detailed_Arhitecture.jpg)
...
-   A Single Sign-On (SSO) service, such as Okta, enables you and your team members to access company applications, such as Contentstack.
...
1.  With Dynamic Website setup, your API keys and delivery tokens are not exposed to the end users.
2.  Depending on your use case, you can implement caching on the application side.
3.  Complicated queries specific to your use case can be done in the application or your dedicated micro (service).  
...
-   [Simple website architecture](/docs/headless-cms/simple-website-detailed-architecture)
