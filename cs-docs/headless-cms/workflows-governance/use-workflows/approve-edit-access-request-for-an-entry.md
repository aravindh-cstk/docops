...
**Note:** It is important to familiarize yourself with the basic concepts of Workflows before starting to work with them. You can refer to these articles: [Workflows,](/docs/headless-cms/about-workflows) [Workflow Stages](/docs/headless-cms/about-workflow-stages), and [Tasks](/docs/headless-cms/about-workflow-tasks).
...
**Additional Resource:** Learn more about [how stage access rules work](/docs/headless-cms/add-workflows-and-stages#add-stage-transition-and-access-rules).
