...
**Note:** If you are not familiar with [Workflow](/docs/headless-cms/about-workflows) and its [Stages](/docs/headless-cms/about-workflow-stages), we recommend you to read about them before proceeding with [Workflow Tasks](/docs/headless-cms/about-workflow-tasks).
