...
**Note:** Before getting started with the [Task](/docs/headless-cms/about-workflow-tasks) filter, make sure you are familiar with the key concepts of [Workflow](/docs/headless-cms/about-workflows) and its [Stages](/docs/headless-cms/about-workflow-stages).

You can refine tasks based on specific filters as shown below:   

![Image-Filters.jpg](https://images.contentstack.io/v3/assets/blt23180bf2502c7444/blt05d926cfd5ba7742/639b2ff03638dd1e41456627/Image-Filters.jpg)
