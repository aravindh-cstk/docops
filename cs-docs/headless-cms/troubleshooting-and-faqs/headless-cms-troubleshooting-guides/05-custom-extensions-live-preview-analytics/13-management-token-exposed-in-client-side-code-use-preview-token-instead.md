...
url: /headless-cms/troubleshooting-and-faqs/headless-cms-troubleshooting-guides/05-custom-extensions-live-preview-analytics/13-management-token-exposed-in-client-side-code-use-preview-token-instead
doc_type: faq
