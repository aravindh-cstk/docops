...
url: /headless-cms/troubleshooting-and-faqs/cli-troubleshooting-guides/01-authentication-network-node-js-environments/09-taxonomy-export-fails-with-access-denied-using-a-management-token-alias
doc_type: faq
