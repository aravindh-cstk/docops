...
**Note:** In CSR mode, the [stackSdk](https://github.com/contentstack/live-preview-sdk/blob/main/docs/live-preview-configs.md#stacksdk) property is required. Passing this object will automatically switch the mode to CSR, allowing you to override the default behavior.
