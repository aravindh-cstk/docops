...
**Note**: Use [Live Preview Utils SDK version 4.0](/docs/headless-cms/get-started-with-live-preview-utils-sdk-v4) or later for improved compatibility with the latest feature updates.
...
The ssr property defines the data update strategy for previewed content based on your app's rendering approach ([Server-Side Rendering](/docs/headless-cms/set-up-live-preview-with-rest-for-server-side-rendering/) or [Client-Side Rendering](/docs/headless-cms/set-up-live-preview-with-rest-for-client-side-rendering/)).
...
**Note:** In CSR mode, the [stackSdk](https://github.com/contentstack/live-preview-sdk/blob/main/docs/live-preview-configs.md#stacksdk) property is required. Passing this object will automatically switch the mode to CSR. This configuration allows you to override the default behavior.
...
The stackDetails object contains stack-specific information for redirection to the corresponding entry whenever you use [edit tags](/docs/headless-cms/set-up-live-edit-tags-for-entries-with-rest/) within your website.
