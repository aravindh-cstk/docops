...
1.  ## Set Up the Website
    ...
    3.  ### Migrate to New Preview Service (recommended)
        ...
        **Additional Resource:** For detailed information on migrating to preview service refer to the [Migrate to Preview Service](/docs/headless-cms/migrate-to-preview-service/) documentation.
    ...
    4.  ### Install and Initialize the Live Preview Utils SDK:
        ...
        You can either usenpm or yarn to install the Live Preview Utils SDK.
