...
-   Access to [stack](/docs/headless-cms/about-stack) settings
...
3.  ## Update Stack Settings
    ...
    2.  [Set the base URL](/docs/headless-cms/add-an-environment/)s for different locales, and click **Save**.![Base URL setup](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/bltbaa7fda3f1479aaa/684ac97134388681002cdeee/1._edit_environment_box.png)
