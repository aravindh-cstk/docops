...
**Note:** To be able to preview entry content, developers need to first [configure Live Preview for the frontend website](/docs/headless-cms/set-up-live-preview-for-your-website) and then [enable it from the stack settings section](/docs/headless-cms/set-up-live-preview-for-your-stack) in Contentstack.
...
![About_Live_Preview.png](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/blt271d3db628fe48fa/6707634aa38ccd54ea94517e/About_Live_Preview.png)

Once opened, the **Live Preview** panel remains available as you work across entries in the entry editor.  The panel:

-   Stays open when you navigate between entries.
-   Preserves its state during entry navigation within the same session.
-   Remembers a custom width and restores it when you open later entries.

As a result, you do not need to reopen or resize the Live Preview panel as you move between entries.

**Note:** The Live Preview panel persistence applies within your current session.
