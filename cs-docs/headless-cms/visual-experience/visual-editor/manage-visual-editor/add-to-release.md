...
4.  In the **Add to Release** modal, select one or more entries from the list.
    1.  A green checkmark indicates the entry is ready to be added.
    2.  Entries without a green check may require review or may not meet publishing criteria.
5.  Click **Proceed**.
...
1.  Use the **URL bar** to open the page associated with the entry.
2.  Open the entry in the **Form panel**.
3.  Click the **entry actions** menu and select **Add to Release**.
4.  Choose the target **Release** and **Locales**.
