...
Only stack [Owners](/docs/headless-cms/types-of-roles#owner), [Admins](/docs/headless-cms/types-of-roles#admin), and users assigned the [Developer](/docs/headless-cms/types-of-roles#developer) role can create roles in a stack.
...
6.  Under **Permissions**, configure the required permissions for entries, taxonomies, assets, and languages
7.  Under **Publishing Environments**, select the [environments](/docs/headless-cms/about-environments) where the role can publish content.
8.  Configure [language](/docs/headless-cms/about-languages) permissions and exceptions as required.
9.  Click **Save**.
...
To create custom roles via API, refer to the [Create a Role](/docs/developers/apis/content-management-api/roles#create-a-role) API request.
