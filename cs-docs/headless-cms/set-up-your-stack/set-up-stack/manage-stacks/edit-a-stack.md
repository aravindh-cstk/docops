...
To edit a stack via API, refer to the [Update a Stack](https://www.contentstack.com/docs/developers/apis/content-management-api/stacks#update-stack) API request.
