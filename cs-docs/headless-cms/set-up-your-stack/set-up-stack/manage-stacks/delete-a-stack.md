...
2.  On the **Stack Settings** page, click **Delete Stack**.
    ...
    ![Stack Settings page showing the Delete Stack option](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/blt55d565d8569fab9e/67beff62304ea9d30d82c9f1/Setup-a-Stack-Delete-Stack-Delete-Icon.png)
    
3.  In the **Delete Stack** modal, enter DELETE to confirm.
    
    ![Setup-a-Stack-Delete-a-Stack-Delete-confirmation-modal.png](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/blt3ef953263210350e/67c032f94f9066ab238f6541/Setup-a-Stack-Delete-a-Stack-Delete-confirmation-modal.png)
