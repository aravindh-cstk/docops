...
You can leave a stack when you no longer need access or want to stop collaborating. However, stack [owners](/docs/headless-cms/types-of-roles#owner) cannot exit directly. They must [transfer ownership](/docs/headless-cms/transfer-stack-ownership) to another user or [delete the stack](/docs/administration/organization-stacks#delete-a-stack).

To leave a stack, log in to your [Contentstack account](https://www.contentstack.com/login/) and perform the following steps:
