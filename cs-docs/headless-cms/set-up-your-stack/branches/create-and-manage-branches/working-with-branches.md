...
Similar to GitHub, Contentstack provides "Branches" to create multiple copies of your stack content. Every [stack](/docs/headless-cms/about-stack) has a **main branch** by default. To create a new branch, you can fork a branch off of the main branch.
