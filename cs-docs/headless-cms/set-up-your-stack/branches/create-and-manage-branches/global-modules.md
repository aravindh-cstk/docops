...
In your organization, you have the option to install [marketplace apps](/marketplace/) for a specific stack. Once installed, these apps can be utilized across all branches within the same stack.
