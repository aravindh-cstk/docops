...
For example, you are working within the development branch, and you add new extensions ([Custom Field Location](/docs/developer-hub/custom-field-location), [Asset Sidebar Location](/docs/developer-hub/asset-sidebar-location), and [Dashboard Location](/docs/developer-hub/dashboard-location)) to this branch. These extensions will be available only within the development branch.
