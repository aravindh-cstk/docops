    ...
    **About Us**
    ...
    -   **Page Components****:** The different sections that you see on your ���About Us" page have been collectively considered together, and hence have used the [Modular Block](/docs/headless-cms/modular-blocks/) field to create the following components:
        ...
        -   **Section with Bucket****:** For the “Our Mission” section, we have made use of a [Global field](/docs/headless-cms/about-global-field/) that contains the following group of fields:
            -   **Title H2:** This is a [Single Line Textbox](/docs/headless-cms/single-line-textbox/) field where you can add the title to the section.
            -   **Description:** This is a [Multi Line Textbox](/docs/headless-cms/multi-line-textbox/) field where you can add the banner description.
            -   **Tabular Buckets:** This is a [Boolean](/docs/headless-cms/boolean) input field that enables you to add a toggle switch (if you turn it on, tabular buckets are activated; if you turn it off, the field is disabled).
            -   **Buckets:** Each bucket might have an image or some information about something important. So we have added a [Group](/docs/headless-cms/group) field within it, including these fields:
                -   **Title H3:** This is a [Single Line Textbox](/docs/headless-cms/single-line-textbox/) field where you can add the headline for your individual bucket.
                -   **Image:** This is a [File](/docs/headless-cms/file/) field where you can choose an appropriate image to add.
                -   **Image Alignment:** This is a [Select](/docs/headless-cms/select) field where you select an image to help set the visual theme or mood of the section and decide on where the image sits in relation to the text (left, right, center).
                -   **Description:** This is a [Multi Line Textbox](/docs/headless-cms/multi-line-textbox/) field where you'd write a brief about what this bucket is about.
                -   **Icon:** This is a [File](/docs/headless-cms/file/) field where you can choose an appropriate icon or graphic to add to represent the bucket's theme.
                -   **Call To Action:** This is a [Link](/docs/headless-cms/link/) field for your buttons where you can add links based on your requirements.
        -   **Awards & Achievements**
            -   **Awards & Achievements:** This is a [Group](/docs/headless-cms/group) field that enables you to group multiple fields together.
                -   **Title:** This is a [Title](/docs/headless-cms/title) field where you can add the headline for your awards & achievements.
                -   **Description:** This is a [Multi Line Textbox](/docs/headless-cms/multi-line-textbox/) field where you can add the required details/descriptions regarding the above.
                -   **Image:** This is a [File](/docs/headless-cms/file/) field where you can choose an appropriate image to add to complement your content.
                -   **Link:** This is a [Link](/docs/headless-cms/link/) field where you can add links based on your requirements.
        -   **Sections****:** This [Global](/docs/headless-cms/about-global-field) field covers a general part of the page, like a paragraph or a block where you can add more details or stories. It consists of the following components:
            -   **Title H2:** This is a [Single Line Textbox](/docs/headless-cms/single-line-textbox/) field where you can add the title to the section.
            -   **Description:** This is a [Multi Line Textbox](/docs/headless-cms/multi-line-textbox/) field where you can add an explanatory text about the section.
            -   **Call To Action:** This is a [Link](/docs/headless-cms/link/) field where you can add CTA links based on your requirements, such as a button that prompts visitors to take action, like “Learn More" or “Contact Us".
            -   **Image:** This is a [File](/docs/headless-cms/file/) field where you can choose to an appropriate image to add to complement your content.
            -   **Is Image Right Aligned:** This is a [Boolean](/docs/headless-cms/boolean) input field that reflects as a toggle switch and enables users to set the alignment of the image.
        -   **Team**
            -   **Team:** This [Reference field](/docs/headless-cms/reference) allows you to fetch team information from the Our Team content type as explained in the section below.
        -   **Contact Us**
            -   Contact: This [Reference field](/docs/headless-cms/reference) allows you to fetch contact information from the [Contact](/docs/headless-cms/contact-us-page#developing-content-type) content type.
