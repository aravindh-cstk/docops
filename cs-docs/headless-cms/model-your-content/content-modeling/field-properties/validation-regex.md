...
1.  Navigate to your [stack](/docs/headless-cms/about-stack) and open the content type where you want to configure regex validation.
2.  Add or edit a **Single Line Textbox** or **Multi-Line Textbox** field.
3.  Open the field properties panel and click the **Advanced** tab.
4.  In the **Validation (Regex)** field, enter the required regex pattern.
