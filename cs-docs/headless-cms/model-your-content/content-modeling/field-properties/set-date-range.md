...
**Additional Resource:** To add this property to the Date field when [creating your content type via an API request](/docs/developers/apis/content-management-api/content-types#create-a-content-type), refer to the [JSON payload of the Date](/docs/headless-cms/json-schema-for-creating-a-content-type#date) field.  
