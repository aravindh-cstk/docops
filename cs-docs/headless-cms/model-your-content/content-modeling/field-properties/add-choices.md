...
-   **Key-value pair choices**: You can toggle the **Key-value enabled** option and add key-value pairs separated by a colon (:). Every choice is separated by a comma.
    ...
    **Note:** Only the key name is displayed on the entry page.
    ...
    For example, we might want to specify the state code for a state while defining choices in a government website, so we can specify key-value pairs such as New York: NY.![Add_Choices_2.png](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/blt1f89ed22c4f7313c/667420f7924c65c19c8ec7c9/Add_Choices_2.png)
...
![Add_Choices_3.png](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/blt8aaa1bd7dea133f9/66742124ca9c56bc8835e800/Add_Choices_3.png)
