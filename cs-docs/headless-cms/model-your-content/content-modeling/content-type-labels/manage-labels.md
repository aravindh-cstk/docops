...
2.  Click the “Gear” icon.  
    ![Manage Labels Gear Icon](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/blta9c64f77933411dd/67a0481a4ddeeaf3b2c82fb5/ManageLabels-Gear.png)
3.  The **Manage Labels** modal appears. From this modal, you can:
    ...
    3.  **Delete a label:** Select the label you want to delete and confirm the action to remove it from the list.  
        ![Delete Label Confirmation](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/blt58875040b9c1814d/67a04a1bf6f9a61b370cf68f/ManageLabels-Edit-Del.png)
