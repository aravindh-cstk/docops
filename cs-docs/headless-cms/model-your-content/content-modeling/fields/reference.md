...
-   [Placeholder Value](/docs/headless-cms/placeholder-value)
...
-   [Referenced Content Type](/docs/headless-cms/referenced-content-type)

**Additional Resource**:

-   Use [Field Visibility Rules](/docs/headless-cms/about-field-visibility-rules) to hide or show fields based on conditions.
...
![CMS-Reference-Fields](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/blt92cc5a8fbff6d8e0/69f311319d3c6d3e9d95d302/CMS-Reference-Fields.png)
...
1.  Add a **Reference** field to the Product content type.
2.  Rename it (for example, _Recommendations_).
3.  Select **Product** as the referenced content type.

![Self_Referencing.gif](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/blta6360b47003f2665/69a407f46f394b86f6d84c24/Self_Referencing.gif)
...
![Navigate_Referenced_Entries_in_an_Overlay.gif](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/amd8e6b072e782ca13/4cee951cca9611c9db4426ad/Navigate_Referenced_Entries_in_an_Overlay.gif)
...
![View_Entry_References.gif](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/blt8f6e2717e56ff107/69a546ab7ba984ac9c9e370e/View_Entry_References.gif)
...
**Note:** The **Create new entry** option is available only if the _Save In Progress Entry_ feature is enabled in your plan.
...
1.  Click the **Edit** icon next to the referenced entry.
2.  The entry opens for editing.
...
1.  Use the **Select content type** dropdown (if multiple types are configured).
2.  Click **Add selected entries**.
