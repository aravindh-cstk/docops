...
When [creating an entry](/docs/headless-cms/create-an-entry) in Contentstack, you can define the URL in the following ways:

-   Manually enter a structured URL
-   Use [URL patterns](/docs/headless-cms/use-default-url-pattern) to automatically generate URLs based on predefined rules and selected values
...
**Additional Resource:** For more details on configuring URL patterns, refer to the [URL](/docs/headless-cms/url) field documentation.

**Note:** URL field properties cannot be modified for [Single](/docs/headless-cms/single-vs-multiple-content-types#single) content types because they contain only one entry and do not require dynamic URL generation.
