...
![Import_a_Taxonomy.png](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/bltc842cceba7747261/69162d7055501ddfaeda54d7/Import_a_Taxonomy.png)
...
-   Refer to the [Restricted Keywords for UIDs](/docs/headless-cms/restricted-keywords-for-uids) to avoid using reserved keywords.
...
1.  Go to your [stack](/docs/headless-cms/about-stack) where you want to import a taxonomy, navigate to the “Settings” icon (press “S”), and select **Taxonomy**.
2.  Click the **Create New Taxonomy** button, then select **Import** from the drop-down menu.![Import Taxonomy.png](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/blt7cc9d9b32362bd7c/6929beb929f9d9a8d30dd7da/Import_Taxonomy.png)
3.  In the **Import Taxonomy** modal, either drag and drop your CSV or JSON file or click **Choose a File** to browse for it.
4.  To display your imported taxonomy at the top of the list, tick the box that says **Display this taxonomy at the top of the list**.
5.  Finally, click **Done** to add your taxonomy.![Import_Taxonomy_Modal.png](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/bltd3f3c17420276b26/65c5dbc3fcd864f6d6eeb4eb/Import_Taxonomy_Modal.png)

After successfully importing the taxonomy, you can start adding terms to it and associating it with content types.

## API Reference

To import a taxonomy via API, refer to the [Import a Taxonomy](/docs/developers/apis/content-management-api/taxonomy#import-a-taxonomy) request.
