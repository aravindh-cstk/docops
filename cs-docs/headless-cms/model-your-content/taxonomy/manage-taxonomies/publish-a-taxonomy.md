...
-   To remove a published taxonomy from an environment or locale, refer to the [Unpublish a Taxonomy](/docs/headless-cms/unpublish-a-taxonomy) documentation.

## API Reference

To publish taxonomies via the API, refer to the [Publish a Taxonomy](/docs/developers/apis/content-management-api/taxonomy#publish-a-taxonomy) API request.
