...
3.  To rearrange the terms, hover over it, then drag and drop it to your desired position. After placing the term, click **Move** in the confirmation popup modal that appears.
    -   To relocate a term as a parent term, use drag and drop when you see a guiding line.![Move_Reorder_a_Term_to_Parent_Level.gif](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/blt730f33bd149f828c/69163706b42d2e2dd1a57624/Move_Reorder_a_Term_to_Parent_Level.gif)
