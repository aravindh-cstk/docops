---
title: "Export Content to CSV File Using the CLI | V1.x.x"
...
url: /headless-cms/cli-export-content-to-csv-file/v1
uid: blt64c4e01079d2e7c2
---

# Export Content to CSV File Using the CLI | V1.x.x
