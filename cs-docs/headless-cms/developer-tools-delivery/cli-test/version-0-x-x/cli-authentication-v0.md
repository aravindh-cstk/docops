...
<table><tbody><tr><td><p><strong>Command</strong></p></td><td spellcheck="false"><p><strong>Mandatory for Import &amp; Export commands?</strong></p></td><td><p><strong>Mandatory for Bulk Publish commands?</strong></p></td></tr><tr><td><p><span class="code">auth:login</span></p></td><td spellcheck="false"><p>Yes, if you want to use authtoken in <span class="code">cm:import&nbsp;</span>or <span class="code">cm:export&nbsp;</span>commands</p></td><td><p>No</p></td></tr><tr><td><p><span class="code">auth:tokens:add -m</span></p></td><td spellcheck="false"><p>Yes, if you don’t want to use authtoken in <span class="code">cm:import&nbsp;</span>or <span class="code">cm:export&nbsp;</span>commands</p></td><td><p>Yes</p></td></tr></tbody></table>
...
**Note:** Before running this command, make sure you have [generated a management token](/docs/headless-cms/generate-a-management-token) in your stack.
...
**Note:** Before running this command, make sure you have [generated a delivery token](/docs/headless-cms/create-a-delivery-token) in your stack.
