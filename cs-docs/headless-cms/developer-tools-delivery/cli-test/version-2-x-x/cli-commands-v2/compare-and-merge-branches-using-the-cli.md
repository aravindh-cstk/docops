...
url: /headless-cms/compare-and-merge-branches-using-the-cli/beta
---
...
Supported values: content-types, global-fields, all

 |
| --stack-api-key | -k | \[Optional\] Provide the stack API key to show the difference between branches. |
| \--format | \- | Type of flags to show the difference.

Supported values: compact-text, detailed-text

Default: compact-text

 |
| \--csv-path | \- | \[Optional\] Custom path for the CSV output file.

If not provided, the system uses the current working directory.
