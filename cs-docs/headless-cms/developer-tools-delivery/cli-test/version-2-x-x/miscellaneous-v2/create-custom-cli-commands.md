---
title: "Create Custom CLI Commands"
description: "Write a Custom CLI Command"
url: /headless-cms/create-custom-cli-commands
---
...
-   Few lines of _optional_ description for this custom plugin.
...
To run the code, open your terminal, point it to the “<<plugin\_name>>” directory (path of your plugin) created above, and run the command given below:
...
When you develop the plugin locally, you can use the **plugins:link** command for setting up the plugin. To do this, open your terminal, point it to the “<<plugin\_name>>” directory, and run the command given below:
