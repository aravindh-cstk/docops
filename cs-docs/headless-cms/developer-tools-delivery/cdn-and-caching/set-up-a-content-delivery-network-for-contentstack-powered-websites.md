...
1.  [Choose a CDN provider](#choose-your-cdn-provider)
2.  [Prepare your website](#prepare-your-website)
3.  [Connect your CDN to your website](#connect-your-cdn-to-your-website)
4.  [Set cache data purging rules](#set-cache-data-purging-rules)
...
3.  ## Connect your CDN to your Website
...
4.  ## Set Cache Data Purging Rules
    
    [Data Purging](/docs/headless-cms/contentstack-cdn-cache-management#cache-purging) refers to the flushing of the data from the CDN cache. You need to balance when and why data is purged from the cache to ensure users receive up-to-date content while keeping costs down and performance high.
    ...
    You can use Contentstack [Webhooks](/docs/headless-cms/about-webhooks) to trigger that the cache is no longer valid and the CDN should purge the cache according to the rules you have set up.
