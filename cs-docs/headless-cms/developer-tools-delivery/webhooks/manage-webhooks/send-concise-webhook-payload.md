...
While creating or updating a [webhook](/docs/headless-cms/about-webhooks), Contentstack allows you to send a concise JSON payload to the specified URL whenever the selected event occurs.
