...
12.  To review the job at any time, go to your stack, click the **Settings** icon in the left navigation panel, and click the [**Bulk Task Queue**](/docs/headless-cms/stack-bulk-task-queue) tab. The find job appears as **Bulk Find** and the replacement as **Bulk Replace** in the **Task Details** column. Open a job to review **All Entries**, **Successful Entries**, and **Failed Entries**, and select **Retry** on any failed entry.
