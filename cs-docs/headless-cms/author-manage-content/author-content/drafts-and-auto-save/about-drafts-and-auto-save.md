...
**Note:** Administrators can [manage](/docs/headless-cms/enable-drafts-and-auto-save) the feature at the stack level. To review or update the setting, navigate to **Settings**, then **Entries** and enable the **Drafts and Auto Save** checkbox.
