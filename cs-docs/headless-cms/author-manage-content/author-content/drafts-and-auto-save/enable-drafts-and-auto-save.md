...
1.  Navigate to your [stack](/docs/headless-cms/about-stack) and click **Entries** or use the shortcut key “E” (for both Windows and Mac users).
2.  Click **Settings** and select **Entries**.
3.  Enable or disable the **Drafts and Auto Save** option.
4.  **Save** your changes.

![Enable_or_Disable_Drafts_and_Auto_Save_.gif](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/blt1adec5e1c37c79e1/69b84ffbee9a6437ec4b0226/Enable_or_Disable_Drafts_and_Auto_Save_.gif)
