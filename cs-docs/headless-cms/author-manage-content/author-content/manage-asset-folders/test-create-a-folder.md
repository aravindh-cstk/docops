...
1.  Go to your [stack](/docs/headless-cms/about-stack), and click the “Assets” icon in the left navigation panel.![Go to your [stack](/docs/headless-cms/about-stack), and click the “Assets” icon in the left navigation panel.](https://images.contentstack.io/v3/assets/blt1a9af0bcb3816d6e/bltdd3fa29f35b79005/6a84895111893c20b1a7739e/1-Assets.png)
2.  Click the **Create new asset folder** icon at the top-right corner of the page.![Click the Create new asset folder icon at the top-right corner of the page.](https://images.contentstack.io/v3/assets/blt1a9af0bcb3816d6e/blt26379ed3c67128ab/6a84895333f24491aa49bb04/2-Create-new-asset-folder.png)
3.  In the **Create Asset Folder** modal, enter a name for your folder (e.g., Project) and click **Create**.![In the Create Asset Folder modal, enter a name for your folder (e.g., Project) and click Create.](https://images.contentstack.io/v3/assets/blt1a9af0bcb3816d6e/blt5ba8ea071b5178c1/6a84895393ffb94c97b8dd6b/3-Create.png)
