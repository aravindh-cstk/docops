...
3.  Hover over the comment you want to edit or delete, then click the "Edit" or "Delete" icon. After editing the comment, click **Update**. ![Edit or delete comment options in Contentstack](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/blt051d0f71dfed8430/678a0ea6ad4fccf7e4402731/Edit-Or-Delete-a-Comment-3.png)

**Note:** Deleted comments are permanently removed and cannot be restored.

**Additional Resource:** Refer to the [JSON RTE comments](/docs/headless-cms/json-rte-comments#edit-or-delete-a-json-rte-comment/) document for editing or deleting comments in JSON Rich Text Editor.
