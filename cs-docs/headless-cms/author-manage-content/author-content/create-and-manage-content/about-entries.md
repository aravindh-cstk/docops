...
-   **Content Types Dependency:** You can create entries only within existing content types. Hence, it is essential to [define your content types](/docs/headless-cms/create-a-content-type) before adding entries.
-   **Branch Specificity:** When working with branches, entries created or updated are [specific to that particular branch](/docs/headless-cms/branch-specific-modules). This means that an entry in one branch won't automatically appear in another, allowing for isolated development and content management.
...
Watch the tutorial video to get an overview on entries.
