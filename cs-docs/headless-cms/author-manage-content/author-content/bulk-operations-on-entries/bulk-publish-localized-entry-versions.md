...
You can publish multiple localized and unlocalized versions of an entry right from the “Publish” modal of the entry's [master language](https://www.contentstack.com/docs/headless-cms/set-the-master-language) version.
...
1.  Go to your [stack](https://www.contentstack.com/docs/headless-cms/about-stack) and click the “Entries” icon in the left navigation panel. You can also use the shortcut key “E” (for both Windows and Mac OS users).
2.  Open the entry you want to publish.
3.  In the top-right corner of the page, select the master language from the dropdown for languages.  
...
4.  Click the **Publish** button at the bottom of the page.![BulkPublish_LocalEntryVersions_Publish.png](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/blt015a08e3bb7d12cb/6764e42d9335677488411445/BulkPublish_LocalEntryVersions_Publish.png)
5.  In the **Publish Entry** modal:

    1.  **Select Environment(s)**: Select the environment(s) where the entry must be published.
    2.  **Select Language(s)**: Click **Select all languages**. ![BulkPublish_LocalEntryVersions_SelectLangg.png](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/blt1aaa60c2907faf5c/6764e42e36f5cc0778daf1fc/BulkPublish_LocalEntryVersions_SelectLangg.png)
...
6.  Finally, click **Send** to publish the entry. ![BulkPublish_LocalEntryVersions_PublishSend.png](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/bltedeaaed118cfa29c/6764e42e575457e5de18cf56/BulkPublish_LocalEntryVersions_PublishSend.png)



    **Note:** When you publish in multiple languages, the latest version of the localized entry will be published.

7.  In the **Publish Reference(s)** modal, click **Send With References** to publish the entry along with the referenced items or **Send Without References** to publish only the entry. ![BulkPublish_LocalEntryVersions_PublishReferences.png](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/blt7ab54347662810e6/6764e42d466737e5e3aa52bf/BulkPublish_LocalEntryVersions_PublishReferences.png)
