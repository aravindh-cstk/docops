...
1.  If you need to revert to a previous version, select the version from the list that you want to restore.
2.  Click the **Save** button to save it as the latest version.

![3-Restore-a-Version.gif](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/bltdd6d7c6a147322ba/66fa90b1f8ea300e47a4ee2b/3-Restore-a-Version.gif)
