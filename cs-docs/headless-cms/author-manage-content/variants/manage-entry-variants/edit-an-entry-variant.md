...
To edit an entry variant via API, refer to the [Update Entry Variant](/docs/developers/apis/content-management-api/entry-variants#update-entry-variant) API requests.
