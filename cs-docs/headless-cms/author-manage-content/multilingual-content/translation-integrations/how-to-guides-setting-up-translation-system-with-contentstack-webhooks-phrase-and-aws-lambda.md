...
1.  ## Set up the Essentials
    ...
    **Note:** Ensure that the languages you add are [supported by Phrase](https://support.phrase.com/hc/en-us/articles/5709608511516-Supported-Languages-TMS). Also, ensure that you have localized the Japanese (ja) locale else the entry in your Japanese locale will not be translated.
...
3.  ## Create a Phrase Account
    ...
    1.  Sign up with [Phrase](https://phrase.com/pricing/).
