...
You can either add a language from our [list of supported languages](/docs/headless-cms/list-of-supported-languages) or [create a custom language](/docs/headless-cms/add-a-custom-language) of your choice.
