...
With the option to delete a localized version of an entry, all the [versions](/docs/headless-cms/understanding-entry-versions) of that entry can also be permanently deleted from the stack.

**Additional Resource:** Learn more about [how localization works in Contentstack](/docs/headless-cms/about-localization) to handle localized entry versions in a better way.
...
![Bulk_Delete_an_Entry_from_Different_Locales_highlighted.jpg](https://images.contentstack.io/v3/assets/blt23180bf2502c7444/blt354ff8eb4a4923f7/6375394532130110b279840e/Bulk_Delete_an_Entry_from_Different_Locales_highlighted.jpg)
...
Learn more about [deleting multiple language versions of an entry](/docs/headless-cms/bulk-delete-localized-entry-versions).
