...
**Note:** By default, the CLI uses the **North America** region. To set the **Europe** or **Azure North Amercia** region, refer to the [Set Region](/docs/headless-cms/configure-regions-in-the-cli/v0#set-region) command for more details.
