---
title: "Bootstrap Starter Apps | V1.x.x"
...
uid: blt9da47fd57e3fd92e
---

# Bootstrap Starter Apps | V1.x.x
...
-   Authenticate CLI using one of the following:
    -   [Login](/docs/headless-cms/cli-authentication/v1#authentication)
    -   [Management Token](/docs/headless-cms/cli-authentication/v1#token-management)
