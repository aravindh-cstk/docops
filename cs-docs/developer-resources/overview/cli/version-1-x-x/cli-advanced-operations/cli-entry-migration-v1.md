...
In Branches, the [merge operation](/docs/headless-cms/compare-and-merge-branches-using-the-cli/v1) is performed on content types and not on the entries within the content types. With the Entry Migration utility, created as part of the Entry Migration flow, you can now merge the entries along with the content types.
...
-   If you want to create a script from scratch, you can use the [Migration](/docs/headless-cms/migrate-your-content-using-the-cli-migration-command/v1) command.
...
-   [Merge operation](/docs/headless-cms/compare-and-merge-branches-using-the-cli/v1#steps-to-merge-branches) performed
