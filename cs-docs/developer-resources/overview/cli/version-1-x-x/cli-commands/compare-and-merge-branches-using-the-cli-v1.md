---
title: "Compare and Merge Branches Using the CLI | V1.x.x"
...
url: /headless-cms/compare-and-merge-branches-using-the-cli/v1
uid: blt12dd3cd4c0194061
---

# Compare and Merge Branches Using the CLI | V1.x.x
...
This step-by-step guides you on how to create, update, delete, compare, and merge Branches using the CLI. In the CLI, the **base branch** refers to the _**target**_ branch, while the **compare branch** is the _**source**_ branch.
...
7.  If you choose **Overwrite with Compare** from step 4, or **New in Compare Only**, **Modified Only**, or **Both** from step 5, choose what you want to do next from the following list:
    ...
    -   **Go Back**: Takes you back to the previous step.
    -   **Start Over**: Takes you back to step 4.
8.  If you choose **Execute Merge and Generate Content Migration Scripts** or **Export Summary and Generate Content Migration Scripts** from step 6, choose what you want to do next from the following list:
...
With this, the merge operation is completed, and the [Entry Migration](/docs/headless-cms/cli-entry-migration/v1) files generated are placed in the “YYYYMMDDHHMMSS\_bltxxx” folder under merge\_scripts folder in the current working directory.
