...
-   [CLI installed](/docs/headless-cms/install-the-cli) (version 2.0.0 and above)
...
-   \-a, \--alias=alias: (mandatory) Delivery token alias.
-   \--\[no-\]doc: (optional) Includes documentation comments. By default, this flag is enabled.
-   \--output=output: (mandatory) The full output path.
-   \--prefix=prefix: (optional) Interface prefix, e.g., "I".
