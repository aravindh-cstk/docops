---
title: "Import Content Using the Seed Command | V2.x.x"
...
uid: blt9f703f1d6c0405d9
---

# Import Content Using the Seed Command | V2.x.x
...
4.  After successful login, export your stack’s content to the stack folder:
    ...
    ```
    csdx cm:stacks:export -k <stack_ApiKey> --data-dir “<path_to_store_content>”
    ```
