---
title: "Configure Rate Limits in the CLI | V2.x.x"
...
# Configure Rate Limits in the CLI | V2.x.x
...
| \--utilize | \- | Provide the utilization percentages for the rate limit, separated by commas.
Default: 50

 |
| \--limit-name | \- | \[Optional\] Provide the limit names separated by commas.

Supported values: limit, getLimit, bulkLimit
