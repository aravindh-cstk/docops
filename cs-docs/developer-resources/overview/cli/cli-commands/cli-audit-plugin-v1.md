...
-   \--fix-only=fix-only: Provide the list of fix options. \[options: reference|global\_field|json:rte|json:extension|blocks|group|content\_types\]
-   \--show-console-output: Displays the audit and audit fix results for individual modules.
