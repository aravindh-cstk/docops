...
The Lytics Mobile SDK facilitates in-app data sharing with iOS and Android. Similar to the JS Tag, the Mobile SDK supports user behavior-based data delivery to Lytics and profile data to the app for real-time personalization. See our [Mobile SDK Documentation](/docs/lytics/sdks-mobile) for more details.
...
-   [Google Big Query](/docs/lytics/google-bigquery-overview)
-   [Amazon Redshift](/docs/lytics/amazon-redshift-overview)
-   [Microsoft Azure](/docs/lytics/microsoft-azure)
-   [Snowflake](/docs/lytics/snowflake)
-   [Databricks](/docs/lytics/databricks)
