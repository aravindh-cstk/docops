...
In the Lytics UI, select **Account** from the main navigation, then select **Usage** from the menu.

![b4e8278-32fe5e9-vault-usage2.png](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/am38785b2f6859d839/cc70355e1bb0c40e1e2a9f40/b4e8278-32fe5e9-vault-usage2.png)

This view offers a quick way to gauge the quantity of data Lytics has received from your various Sources. Of course, if you would like to explore details for incoming data further you can view more granular details of all connected Sources from the **Data Pipeline** interface.
...
Automated alerts for Inbound Event Quotas can be configured to sent to [Microsoft Teams](/docs/lytics/microsoft-teams#microsoft-teams-event-quota-alerts), [Slack](/docs/lytics/slack#slack-event-quota-alerts), or directly to an [email address](/docs/lytics/lytics-monitoring#email-event-quota-alerts).
