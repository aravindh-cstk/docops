...
The [Lytics Query Language (LQL)](/academy/lql-and-data-import-basics) allows you to refine your target audience and remove customers with certain profile attributes or behaviors, enabling further efficiencies in your ad spend.

### Targeted Ad Campaigns

Examples of how Lytics audiences can help with your most common targeted advertising.

-   [Smarter 'lookalike' prospecting with Facebook“Lookalike” audiences](/docs/lytics/increase-conversions-with-lytics-and-facebook-lookalike) based on your most valued customers’ behaviors, engagement scores, and lifetime value.
-   [Target your users with content they are interested in](/docs/lytics/promote-relevant-content-to-users-based-on-their-interests) using Lytics topics and content affinity scores for building your audiences.
