...
-   [_Google Ad Rank Overview_](https://support.google.com/google-ads/answer/1752122)
-   [_Additional Information About Google Ad Position and Ad Rank_](https://support.google.com/google-ads/answer/1722122)
-   [_Facebook Ads Targeting & Positioning Policy_](https://www.facebook.com/policies/ads/)
-   [_Facebook Low Quality or Disruptive Content Policy_](https://www.facebook.com/policies/ads/prohibited_content/low_quality_or_disruptive_experiences)
...
Example of full page takeover on the second click of a user's first visit before they had a chance to explore the brand.\\ ![purple-popup](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/am31001138fe819642/6ad6da1fed50979619889016/purple-popup.png)

Example of half page takeover on user's first visit.\\ ![neilpatel-popup](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/am5c2c948391c7647a/be6577cbeefaa09357d8fb4f/neilpatel-popup.png)

Added for comedic value. First page view popup on article talking about discussion one of Google's many announcements to penalize such experiences.\\ ![random-popup](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/am62b4b83daeb7ed30/408536928250ad2674f63975/random-popup.png)

Because Lytics allows you to target users based on [profile details](/docs/lytics/understanding-user-profiles), audience membership and behavior in real-time, perhaps you take a more subtle approach for new customers while being a bit more bold with visitors showing strong signs of conversion or history with your brand.
...
Example of cookie acceptance modal on desktop - small and not disruptive.\\ ![nextweb-deskop](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/am57ad58659858628e/ba1a2a331d91c7841b1a6322/nextweb-deskop.png)

Example of cookie acceptance modal on mobile - much larger and more disruptive.\\ ![nextweb-mobile](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/am4cb31331ed486cd2/b2ba48babb338730d44884e7/nextweb-mobile.png)

### 4\. Time on Site & Session Depth

As we mentioned in our first example where the visitor received an offer immediately upon their first page view, one thing to consider and test is when a modal is shown. Lytics offers a variety of [display options](/docs/lytics/experiences#display) which allow you to only show the modal after a set amount of seconds, after some amount of scrolling, etc. All of these levers can ensure a message is delivered after a visitor has made a connection and consumed enough content in order to make the modal experience positive.

### 5\. Inline Personalization

The Lytics [web personalization SDK](/docs/lytics/personalization-pathfora) is one method for delivering personalized communications on site. It was designed to offer a light lift and quick time to value but may not meet the needs of every use case. As such, the [Lytics JavaScript tag](/docs/lytics/lytics-javascript-tag)and various [Personalization](https://docs.lytics.com/reference/personalization) APIs can be leveraged in more custom applications to offer hyper targeting and personalized content in virtually any situation.
