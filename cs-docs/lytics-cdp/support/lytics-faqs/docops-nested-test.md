---
title: "DocOps Nested Test - Lytics CDP"
description: "Temporary nested test article for the Lytics CDP product, covering local images, all four callout types, lists, tables, code blocks, and links in a single pass."
url: /lytics-cdp/docops-nested-test
---

# DocOps Nested Test - Lytics CDP

## Overview

This is a temporary test article verifying nested-folder sync, image upload, callouts, and full text formatting for **Lytics CDP**. Safe to delete after verification.
...
```bash
echo "docops nested sync test for Lytics CDP"
```
