...
- If your entry is not added to any release or scheduled for publishing, input a tentative **Date** and **Time** to proceed with the preview.
- ## Scheduled Publishing
For entries scheduled to be published, select the **Environment** and **Locale** to preview your website.
- If the entry is scheduled for publishing, you will see a dropdown to select the **Scheduled Publish** option.
...
- Alternatively, in the **Releases** module, if you try to preview an undeployed release, you will be prompted to input a tentative **Date** and **Time**.
