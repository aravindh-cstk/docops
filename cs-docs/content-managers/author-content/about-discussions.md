...
# [Author Content] - About Discussions

This page explains how Discussions work in Contentstack entries, including key features, limits, and where to access and manage discussions. It is intended for content managers and authors who collaborate on entries and need to track, resolve, or revisit field-level feedback during content creation and review.
...
### Where do I find Discussions while editing an entry?
You can access and manage all discussions from the Discussions section, located in the right-hand navigation panel of the entry editing screen.

### Can I have multiple active discussions on the same field?
No. Only one active discussion per field is allowed at a time.

### What are the limits for discussions and comments?
A maximum of **100 discussions** can be created per entry per locale, and each discussion can include up to **1000 comments**.

### Do resolved discussions disappear?
No. Even after resolution, discussions are retained in the Discussions panel for reference.