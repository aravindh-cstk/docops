...
2.  On the subscription card, click the vertical ellipsis (⋮), and then click **Cancel & Delete Account**. The ellipsis appears on paid subscription options only.
3.  In **Before You Go**, Contentstack shows the lower subscription options you could move to instead. To keep your organization on a smaller subscription, click **Downgrade Instead**. To continue canceling, click **Cancel & Delete Account**.
4.  Select the reason you are canceling, and then click **Continue**. To stop here, click **Keep My Plan**.
