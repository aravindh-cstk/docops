...
3.  From the language selector at the top of the asset details page, select a language marked as **Unlocalized**.
4.  Update the required fields, such as title, description, tags, user-defined metadata, or asset binary if needed (e.g., replace an image containing localized text).
5.  Click **Save Asset**.
6.  In the confirmation dialog, select **Localize Asset**.
