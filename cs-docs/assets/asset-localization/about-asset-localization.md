...
1.  You upload an image and add metadata in English.
2.  You add French as a language with English as its fallback.
3.  You switch to the French version and:
    -   Update the title and description in French
    -   Add French tags
