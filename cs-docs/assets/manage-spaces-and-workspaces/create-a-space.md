...
2.  Click **\+ New** and select **Space**.
3.  In the **New Space** modal, enter the following details:
    -   **Name** (required): Provide a clear, descriptive name for your space (e.g., “Marketing” or “Documentation”).
