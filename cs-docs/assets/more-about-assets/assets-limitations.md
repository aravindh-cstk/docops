...
-   **Maximum assets across organization:** Up to **500,000 assets**
...
-   An asset can only be localized into languages that:
    -   Exist globally, and
    -   Are enabled for the current workspace
-   Asset localization is applied **per language**, not per region or site.
-   Assets selected in CMS entries must match:
    -   The entry’s locale, or
...
-   Workspaces are not intended to represent:
    -   Separate websites
    -   Separate brands
...
-   User-defined fields:
    -   Must be created at the space level before assignment
...
-   Asset access is always scoped by:
    -   Assigned roles, and
    -   Assigned spaces
...
-   Assets in the following states cannot be delivered via URLs:
    -   Pending scan
    -   Quarantined
    -   Deleted
