...
2.  Open the required asset to access the asset details page.
3.  Click the “Replace” icon at the bottom of the page.
4.  Select the new file from the local system.
5.  Click **Save Asset** to confirm the replace action.
