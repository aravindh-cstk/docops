...
-   **Project Settings**, then **Configuration**, filled in: Environment, Language, Canvas URL ([Configure project](/docs/studio/configure-environment-language-and-canvas-url))
...
1.  Open **Compositions**, then the **Templates** tab, then **\+ New Template**
...
Then ask: "Verify my Studio setup." The LLM walks the layered diagnostic and tells you exactly what's missing.
