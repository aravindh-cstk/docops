...
![Hero Strip section canvas with Hero component selected: right panel Properties shows Headline, Subhead, Cover image, CTA label, CTA link fields, and an Actions slot prop showing "The slot is empty, with no component added yet."](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/am369161d1ac491b03/320f1d954af1f5b90918632a/hero-component-dropped-with-actions-slot.png)

After dropping a Section Slot inside the Hero's slot prop, the canvas shows the dashed drop target in place:

![Hero Strip section canvas: "Welcome to Studio" headline and subhead bound from the linked entry, with a "Drop a Button or Link here" Section Slot placeholder visible inside the hero frame. All component palette categories collapsed.](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/am1f94a8168cc93321/bdc00f5e991d55c5c347a8c9/section-hero-strip-with-slot.png)
...
![card_grid section linked to gf_card_list — Box configured as a grid wraps a Repeater bound to template.items\[\] holding a Section Slot labelled Item template](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/amc211395eda9bf4ae/bbb44ca7ca0a1d2b4ee07f23/containers-section-slot-list-pattern.png)

The Global Field that defines the iteration source:

![Two stacked global field schemas — gf_card_list with heading and items\[\] repeater on top, gf_card with title, image, link below — connected by an arrow showing items\[\] iterates each gf_card](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/amc57cdeb104c54efe/0c559c28b8a05964416c3a64/containers-section-slot-card-list-schema.png)
...
![card section linked to gf_card — a Box card frame with four Section Slots labelled Media, Headline, Body, Action](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/amfb8fcf5d32947d6a/073e1e1a4f8e783f8ad2101f/containers-section-slot-card-anatomy.png)
...
![card_grid bound to featured_products contains an Item template slot; a card section dropped in exposes four named slots — Media, Headline, Body, Action — each labelled with what to drop](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/am54374fb8561effd0/9e0b8dca61cc4986ea559cfd/containers-section-slot-nested-chain.png)
