...
- Click **Delivery Token** to create a new token.
  ...
  **Tip:** If you are on the [Management Tokens](../developers/create-tokens/about-management-tokens.md) tab, you can press “Alt + O” (Windows) or “Option + O” (Mac) to navigate to the Delivery Tokens tab.
