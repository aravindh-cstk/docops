...
The Delivery SDK reads published content from Contentstack's content delivery network (CDN). Studio doesn't fetch content itself. It asks the Delivery SDK to do it. So this is the first install.
