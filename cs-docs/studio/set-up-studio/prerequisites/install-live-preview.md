...
Then: "install Live Preview in this project". The skill detects your framework, adds the live\_preview block to your Delivery SDK init, and wires onEntryChange to your render layer.
