...
See [configure-csr-vs-ssr](/docs/studio/choosing-between-csr-and-ssr-rendering) for the wiring.
...
| Using CSR useCompositionData for content that could be fetched server-side | Adds an extra round-trip and runtime cost; SSR is faster and lighter |
...
-   [Configure CSR vs SSR](/docs/studio/choosing-between-csr-and-ssr-rendering): pick the right render path
-   [Optimizing load](/docs/studio/optimizing-load-with-lazy-registration): lazy registration and bundle reference
-   [Production deployment edges](/docs/studio/production-deployment-edge-cases): edge runtime and ISR considerations
