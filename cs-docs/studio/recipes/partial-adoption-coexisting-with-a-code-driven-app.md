...
![Three patterns for adding Studio to a code-driven app: catch-all route for new pages, full route-swap migration for pages you fully manage in Studio, and embedded composition for one editable region inside a code-owned page.](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/am8ad5c57eb0d35ce2/bec17e93b1bf37ad1486f84d/recipes-partial-adoption-decision-tree.svg)
...
> 
> > _"The difference between catch-all and optional catch-all segments is that with optional, the route without the parameter is also matched (/shop in the example above)."_
> 
...
![Next.js app/ folder layout with the Studio catch-all alongside existing code routes. Only app/\[...slug\]/page.tsx is new; everything else is code.](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/am00344da6959e3013/cb3bc6ff0d1ea7aa88e5e28d/recipes-partial-adoption-file-layout.svg)
...
### Step 3 — Add a new content type → Studio renders it for free
...
| Your app has no existing routes; you want Studio to render everything from day one | Zero to first page → standard catch-all setup; no precedence carveouts |
