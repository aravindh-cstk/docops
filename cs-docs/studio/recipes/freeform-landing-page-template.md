...
![Two content types — campaign and product — with their fields listed.](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/am88e963f18d39a1fb/37e54a24135872bda4f7a958/recipes-freeform-content-types.svg)
...
If you already have a landing\_hero section (built in the overrides recipe), drop it. Otherwise build one inline:
...
![Spring 2026 freeform landing page render — a hero band with a headline, subline, and Get access CTA, plus three Featured-products cards beneath with image, name, price, and Shop link.](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/amcd4723e92dba95fb/3397f926e0f490d3dd78e609/recipes-freeform-landing-output.svg)
...
-   **The query stays live.** Marketing publishes a new featured product → it appears on this template automatically.
