...
A Freeform template has no such entry. So when the layout needs to render specific content from the CMS, say a campaign's headline, a featured product's image, a testimonial's quote, you need a way to bring those entries onto the template **explicitly**. That's what Pinned Entries does.
