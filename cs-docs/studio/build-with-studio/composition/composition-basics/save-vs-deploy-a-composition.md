...
The Deploy button sits next to Save. Clicking it opens the **Deploy** modal: pick which environments to publish to, select whether to send referenced entries along with the composition, and confirm.
...
4.  **Verify the environment.** Confirm you're deploying to the right environment, as the canvas's Preview Environment might differ from your target.
...
-   [Templates](/docs/studio/templates-overview): what gets deployed
