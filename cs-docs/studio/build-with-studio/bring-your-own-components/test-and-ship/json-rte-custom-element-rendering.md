...
The config is the standard IJsonToHtmlOptions shape from [@contentstack/json-rte-serializer](https://github.com/contentstack/json-rte-serializer):
...
-   [@contentstack/json-rte-serializer README](https://github.com/contentstack/json-rte-serializer/blob/master/README.md#custom-element-types): upstream serializer reference.
