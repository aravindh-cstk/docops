...
![Three-step flow: click the component, open the Data tab, then type a literal or click the binding chip to open the Data Picker](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/am15950cb3b9a3be39/9b140eaf4e802f684f57f661/templates-bind-component-flow.png)
...
When you drop a section onto a template, Studio matches the section's **linked schema** against fields on your page's content type to determine the binding.
