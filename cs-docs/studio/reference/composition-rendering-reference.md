...
<StudioComponent /> accepts exactly two props ([studio-react/src/renderer/renderer.type.ts:46](https://www.npmjs.com/package/@contentstack/studio-react)):
...
Type definition ([studio-client/src/composable-studio/composable-studio.type.ts:265](https://www.npmjs.com/package/@contentstack/studio-react)):
...
Use this for **anything not in Contentstack**, such as pricing APIs, A/B variant flags, geolocation, weather, user profile, and URL search params. See [Component Default Data](/docs/studio/set-component-default-data) and the wire-external-data skill.
...
Before any fetcher runs, you initialise the SDK with studioSdk.init({...}). The config schema ([studio-client/src/config/config.schema.ts](https://www.npmjs.com/package/@contentstack/studio-react)):
...
Type ([studio-messenger/src/fetch-spec.type.ts:8](https://www.npmjs.com/package/@contentstack/studio-react)). One of these five shapes; the SDK enforces at-least-one-identifier via the type:
...
Type ([studio-client/src/composable-studio/composable-studio.type.ts:128](https://www.npmjs.com/package/@contentstack/studio-react)):
...
-   [Wire external data](/docs/studio/set-component-default-data#part-2-runtime-component-default-data-the-prop-on): skill that wires runtime data through the data prop
-   [Configure CSR vs SSR](/docs/studio/choosing-between-csr-and-ssr-rendering): pick fetchCompositionData (SSR) vs useCompositionData (CSR)
