...
-   **Public:** These apps are available in our public marketplace for any customer to install and configure. Only Contenstack can convert an application to Public. [Learn More](/docs/marketplace/app-submission-and-approval-guide) here to see how you can get your app listed.
