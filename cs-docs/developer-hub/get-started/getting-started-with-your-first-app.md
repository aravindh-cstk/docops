...
-   [Apps CLI Plugin](/docs/headless-cms/apps-cli-plugin) configured for Contentstack CLI
...
1.  ### Set up and Register an App
    ...
    As a first step, you need to create a project directory where you can work in. You can use the Contentstack [Apps CLI Plugin](/docs/headless-cms/apps-cli-plugin) to clone the Marketplace App Boilerplate for creating your project.
