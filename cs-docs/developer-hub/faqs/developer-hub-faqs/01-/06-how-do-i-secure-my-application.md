...
While communication to Contentstack from outside resources, use [OAuth support token](/docs/developer-hub/contentstack-oauth) instead of user session tokens or management token. These are easy to manage and scale as per the app developer’s demand.
