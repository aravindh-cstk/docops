...
url: /agent-os/troubleshooting-and-faqs/agent-os-troubleshooting-guides/02-triggers-filters-workflow-logic/06-automation-cannot-be-activated-more-than-10-if-else-blocks-cause-the-automations
doc_type: faq
