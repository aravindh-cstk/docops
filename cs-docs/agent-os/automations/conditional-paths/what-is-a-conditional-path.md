...
Refer to the [Using Conditional Paths to Customize Automations](/docs/agent-os/using-conditional-paths-to-customize-automations/) use case to narrow down your automation for specific tasks.
