...
2.  [Delete a Record](#delete-a-record)
3.  [Get Single Record](#get-single-record)
4.  [Get Records](#get-records)
...
5.  Click the **\+ Add New Account** button to add your Airtable account.  
    ![Add_New_Account_Create_Record](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/blt8520858a8f8362c8/645c88a522f998927fc598d4/Add_New_Account_Create_Record.png)
6.  In the pop-up window, mark the checkboxes for all the OAuth permissions and then click the **Authorize** button.  
    ![Click_the_Authorize_button](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/blt53ae03d3be81a97e/645c88b032acc846f05ee2f2/Click_the_Authorize_button.png)
...
13.  Click the **Test Action** button to test the configured action.  
     ![Test_Action](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/blt7f2f39078eb1680c/645c88e0c796956b75e27558/Test_Action.png)
14.  Once set, click the **Save and Exit** button.  
     ![Save_Exit_Create_Record](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/blt015b68fd1cc5005e/645c88bb897f62dffb44c103/Save_Exit_Create_Record.png)
...
1.  Under **Choose an Action** tab, select the **Delete a Record** action.  
    ![Select_the_Delete_a_Record_Action](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/blt5116708cbdc3dfd3/645c88df805b40d7ab5eba92/Select_the_Delete_a_Record_Action.png)
2.  Click the **\+ Add New Account** button to add your Airtable account.  
    ![Add_New_Account_Delete_Record](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/blt7bc66226e6cdfc54/645c88a5190e6e158c6fd299/Add_New_Account_Delete_Record.png)
...
8.  In the **Record ID** field, select the ID of the record you want to delete from the **Lookup** dropdown.  
    ![Select_Fields_Delete_Action](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/blt6c0b6b814e15a57c/645c88d2897f62657844c109/Select_Fields_Delete_Action.png)
...
11.  Once set, click the **Save and Exit** button.  
     ![Save_Exit_Delete_Record](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/blt08265d449314dd62/645c88c70906cc5400ce0b4e/Save_Exit_Delete_Record.png)
...
1.  Under **Choose an Action** tab, select the **Get Single Record** action.  
    ![Select_the_Get_Single_Record_Action](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/blte147dd8b8ae28894/645c88df8a8445053810143a/Select_the_Get_Single_Record_Action.png)
2.  Click the **\+ Add New Account** button to add your Airtable account.  
    ![Add_New_Account_Get_Single_Record](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/bltbcb2d7fd62c89717/645c88b07578d5c607e6811d/Add_New_Account_Get_Single_Record.png)
3.  In the pop-up window, mark the checkboxes for all the OAuth permissions and then click the **Authorize** button.  
    ![Click_the_Authorize_button](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/blt53ae03d3be81a97e/645c88b032acc846f05ee2f2/Click_the_Authorize_button.png)
4.  Click **\+ Add a base** to add a new database or select an existing one. Click **Grant access** to allow access to Airtable.  
    ![Grant_access](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/blta8585c09ad23174b/645c88b1c7969599f0e27550/Grant_access.png)
...
8.  In the **Record ID** field, select the ID of the record you want to fetch from the **Lookup** dropdown.  
    ![Select_Fields_Get_Single_Record](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/blte3da977ae3a410a8/645c88d26f143f777a6d0822/Select_Fields_Get_Single_Record.png)
9.  Click the **Proceed** button.
10.  Click the **Test Action** button to test the configured action.  
     ![Test_Action](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/blt7f2f39078eb1680c/645c88e0c796956b75e27558/Test_Action.png)
11.  Once set, click the **Save and Exit** button.  
     ![Save_Exit_Get_Singal_Record](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/blt7192e85f2802fbbc/645c88c8805b40ccad5eba8a/Save_Exit_Get_Singal_Record.png)
...
1.  Under **Choose an Action** tab, select the **Get Records** action.  
    ![Select_the_Get_Records_Action](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/bltaf527c288141930f/645c88df528846b71b8b6877/Select_the_Get_Records_Action.png)
2.  Click the **\+ Add New Account** button to add your Airtable account.  
    ![Add_New_Account_Get_Records](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/blt31e25423eea2afca/645c88a58dbb8266c233f795/Add_New_Account_Get_Records.png)
3.  In the pop-up window, mark the checkboxes for all the OAuth permissions and then click the **Authorize** button.  
    ![Click_the_Authorize_button](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/blt53ae03d3be81a97e/645c88b032acc846f05ee2f2/Click_the_Authorize_button.png)
4.  Click **\+ Add a base** to add a new database or select an existing one. Click **Grant access** to allow access to Airtable.  
    ![Grant_access](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/blta8585c09ad23174b/645c88b1c7969599f0e27550/Grant_access.png)
...
12.  Once set, click the **Save and Exit** button.  
     ![Save_Exit_Get_Records](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/blt994e28eb5f89f122/645c88c7065c95c773561210/Save_Exit_Get_Records.png)
...
1.  Under **Choose an Action** tab, select the **Update a Record** action.  
    ![Select_the_Update_Record_Action](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/blt1f8c91488fe395c7/645c88df065c955657561214/Select_the_Update_Record_Action.png)
2.  Click the **\+ Add New Account** button to add your Airtable account.  
    ![Add_Account_Update_Record](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/bltde979483112c73e2/645c88a5065c95f7d156120c/Add_Account_Update_Record.png)
3.  In the pop-up window, mark the checkboxes for all the OAuth permissions and then click the **Authorize** button.  
    ![Click_the_Authorize_button](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/blt53ae03d3be81a97e/645c88b032acc846f05ee2f2/Click_the_Authorize_button.png)
4.  Click **+ Add a base** to add a new database or select an existing one. Click **Grant access** to allow access to Airtable.  
    ![Grant_access](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/blta8585c09ad23174b/645c88b1c7969599f0e27550/Grant_access.png)
...
10.  Click the **Proceed** button.
11.  Click the **Test Action** button to test the configured action.  
     ![Tset_Action](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/blt7f2f39078eb1680c/645c88e0c796956b75e27558/Test_Action.png)
12.  Once set, click the **Save and Exit** button.  
     ![Save_Exit_Update_Records](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/bltc7b028241160ba67/645c88c8805b4083285eba8e/Save_Exit_Update_Records.png)
