...
7.  In the **Authorize** modal, enter a **Title**. Enter the **Delivery** **Token** of your stack. Click the **Authorize** button.  
    ...
    **Additional Resource:** To learn more about Delivery Tokens, refer to the [Working with Delivery Tokens](/docs/headless-cms/overview-of-tokens#work-with-delivery-tokens) guide.
...
2.  On the **Get All Entries** **Configure** **Action** page, enter the details given below:
    ...
    4.  Provide your data in the **Customized Data (query)** field to filter the entry. Enter your data in the **Key**, **Operator**, and **Value** fields.
        ...
        In the **Customized Data (query)** field, you can filter the entry based on _Updated At/Created At_ options. For example, you can fetch all the entries updated after a certain time and date as shown below:
