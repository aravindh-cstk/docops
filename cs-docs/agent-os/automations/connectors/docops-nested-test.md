---
title: "DocOps Nested Test - Agent OS Connectors"
description: "Temporary nested test for Agent OS Connectors: local images, all four callout types, lists, tables, code blocks, and links."
url: /agent-os/docops-nested-test-connectors
---

# DocOps Nested Test - Agent OS Connectors

## Overview

This is a temporary test article verifying nested-folder sync, image upload, callouts, and full text formatting for **Agent OS Connectors**. Safe to delete after verification.
...
```bash
echo "docops nested sync test for Agent OS Connectors"
```
