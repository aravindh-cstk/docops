...
This guide offers a step-by-step approach to using the Coveo connector to manage content on the Coveo platform.
...
**Note:** Make note of the API key and the Organization ID that we have fetched, we will need this while setting up the account.

## Connect your Coveo Account
