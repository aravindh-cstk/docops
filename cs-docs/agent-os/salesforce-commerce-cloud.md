...
- Within the **Configure Action Step**, click the **Salesforce Commerce Cloud **connector.
- Under **Choose an Action** tab, select the **Get Product Details** action.
- In the **Configure Action** tab, click **+ Add New Account** to add your Salesforce Commerce Cloud account.
