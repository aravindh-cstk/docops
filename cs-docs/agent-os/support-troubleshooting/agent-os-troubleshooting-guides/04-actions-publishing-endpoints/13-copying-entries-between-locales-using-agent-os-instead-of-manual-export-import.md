...
url: /agent-os/support-troubleshooting/agent-os-troubleshooting-guides/04-actions-publishing-endpoints/13-copying-entries-between-locales-using-agent-os-instead-of-manual-export-import
doc_type: faq
