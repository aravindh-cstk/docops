...
url: /agent-os/support-troubleshooting/agent-os-troubleshooting-guides/04-actions-publishing-endpoints/08-agent-os-elasticsearch-connector-authentication-fails-with-username-password
doc_type: faq
