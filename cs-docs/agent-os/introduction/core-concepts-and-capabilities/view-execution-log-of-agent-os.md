...
**Additional Resource:** Refer to the [Executions in Agent OS](/docs/agent-os/executions-in-agent-os) documentation to learn about the execution statuses.
...
2.  Open your project or [create](/docs/agent-os/managing-projects#create-a-project#create-a-project) a new one.
...
-   **Input and Output:**
    ...
    ![Execution_log_agent](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/bltad29b072aea92f8a/69987601b13d650008b4fc28/Execution_log_agent.png)
...
-   **Input and Output:**
    ...
    ![Automations_execution_screen](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/bltd1e17e7582769585/6998760131a5c5000890e2ff/Automations_execution_screen.png)
