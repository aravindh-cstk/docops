...
The **Audit Log** section helps you monitor the activities performed in a particular [project](/docs/agent-os/managing-projects#create-a-project).
...
3.  Go to your project or [create](/docs/agent-os/managing-projects#create-a-project#create-a-project) a new one.
...
The App is edited/re-authorized
