...
-   **Soft Limit:**
    ...
    The soft limit marks the threshold at which the organization’s number of executions for the month exceeds the purchased plan for that organization. At this point, the organization will begin paying for executions at the negotiated rate per 100 executions, and all users will get a warning message on Automations and Agents landing page. The site organization owners will also get an email notification.  
...
**Additional Resource:** For more information, refer to the [Supported Capabilities of Agent OS](/docs/agent-os/supported-capabilities-of-agent-os) document.
