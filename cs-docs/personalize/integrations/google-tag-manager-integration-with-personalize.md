...
-   Access to your [Google Tag Manager](https://marketingplatform.google.com/about/tag-manager/) account

## What You Will Learn

-   How to create a GTM account and container and install it on your site.
...
1.  ## Create an GTM Account, Container and Install a Web Container
    ...
    **Note:** If you are using a web framework, there may be an easier way to install the GTM tag. For example, [Next.js](https://nextjs.org/docs/app/guides/third-party-libraries#google-tag-manager) provides a custom integration for GTM: [Google Tag Manager.](https://nextjs.org/docs/app/guides/third-party-libraries#google-tag-manager)
...
2.  ## Set up and Manage Tags in Google Tag Manager
    ...
    4.  In the **Tag Configuration** section,
        ...
        9.  In the **Advanced Settings**, configure the **Tag Sequencing**. Tag Sequencing is used to specify tags to fire immediately before or after the current tag.![image.png](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/blt4fb9f4ec0c2dd892/688aeaff755af22ab709d3e4/image.png)
    5.  Click **Save**.
    ...
    4.  In the **Tag Configuration** section,
        ...
        9.  **In the Triggering section, configure an event/trigger for which you want the tag to be executed.**
        ...
        10.  **Click the Save button to save the tag configuration.**
        ...
        **Use the following steps to set up the tag for the Set UserId action in GTM.**
        ...
        6.  **In the Triggering section, configure an event/trigger for which you want the tag to be executed.**
            ...
            4.  **In the Trigger Configuration section,**
                ...
                3.  **Enter** _**is\_logged\_in**_ **in the Event name field.**![Custom_Event.png](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/blt7c1ebf1b873e5b80/69c3e3db191b6b098b7c8242/Custom_Event.png)
        ...
        **Use the following steps to set up the tag for the Set Attributes action in GTM.**
        ...
        5.  **In the Triggering section, configure an event/trigger for which you want the tag to be executed.**
            ...
            4.  **In the Trigger Configuration section,**
                ...
                5.  **Then click the Save button to save the trigger configuration.**
        6.  **Click the Save button to save the tag configuration.**
    5.  ## **Preview and Publish your GTM Tags**
        ...
        **Additional Resource:** [**documentation**](https://support.google.com/tagmanager/answer/6107163)**.**
    ...
    **You can refer to the following project for a reference implementation:** [**https://github.com/contentstack-personalize-examples/nextjs-example-launch-gtm**](https://github.com/contentstack-personalize-examples/nextjs-example-launch-gtm)**. It is built using the Next.js framework and is hosted on Contentstack Launch here:** [**https://personalize-demo-with-gtm.contentstackapps.com**](https://personalize-demo-with-gtm.contentstackapps.com)**.**
