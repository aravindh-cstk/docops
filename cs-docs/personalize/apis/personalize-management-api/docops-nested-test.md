---
title: "DocOps Nested Test - Personalize"
description: "Temporary nested test article for the Personalize product, covering local images, all four callout types, lists, tables, code blocks, and links in a single pass."
url: /personalize/docops-nested-test
---

# DocOps Nested Test - Personalize

## Overview

This is a temporary test article verifying nested-folder sync, image upload, callouts, and full text formatting for **Personalize**. Safe to delete after verification.
...
```bash
echo "docops nested sync test for Personalize"
```
