...
You can track impressions using the [Personalize Edge SDK](/docs/developers/sdks/personalize-edge-sdk/javascript/about-javascript-personalize-edge-sdk#edge-sdk) and [Personalize Edge API](/docs/developers/apis/personalize-edge-api). And also, use tools like [Google Tag Manager,](/docs/personalize/about-gtm-integration/) [Customer Data Platform](/docs/personalize/about-cdp-integration/) integrations or similar platforms. This data is then shown in the 'Analytics' section for each experience, and it's further categorized for each variant.
