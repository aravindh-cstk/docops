...
-   How to add a custom attribute to an audience as a rule.

-   How to set the attribute, operator, and value for a rule.

-   How to add multiple preset and custom attributes to an audience.
...
5.  In the **Rules** section, click the **\+ Add Rule** button.![Add Rule button](https://lh7-rt.googleusercontent.com/docsz/AD_4nXfIeee7sbfn8aL8f0xKfjuhjmRzajciE1q5lAgW-nKkWlbgD4KtxNnY-Ghacv1KA0ig_MWV4wsElDxv32a4b3YWh7dLgI-wqrvULfPIQgxrclP7JC-B5h5CCAZ6MTeUhdv505BOreVvfglc4VBeLSfVDYqv?key=xdiy-Lh4PD3Y48RoXD83ZA)
    ...
    -   Enter a matching criterion for the condition in the **Select Value** field.![Select Value field](https://lh7-rt.googleusercontent.com/docsz/AD_4nXdBS9JhGBRXPGsbg18Er3T6aexmtDPN88qZrBUGpSqp-mTYZLV_YsHjAmOLliDh61W2zcGvOMH-jv_zZEOqCILwfn3BjETgCdhiA-rZi9XUfGDsrFvgOKWCHm4xa-0sOmqQowXc5TIOv18wCMu6dh1eNFRo?key=xdiy-Lh4PD3Y48RoXD83ZA)
...
-   [Personalize Edge API: User Attributes](/docs/developers/apis/personalize-edge-api/user-attributes)
-   [Personalize Management API: Attributes](/docs/developers/apis/personalize-management-api/attributes)
