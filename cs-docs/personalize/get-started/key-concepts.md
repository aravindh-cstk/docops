...
You can attach **tags** to any experience to organize it in the management UI and to control which experiences are evaluated at runtime. Tags are free-form strings, such as env:production, section:homepage, or campaign:black-friday, with no predefined taxonomy.
