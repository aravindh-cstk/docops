...
**Warning**: This set up guide is deprecated. Please visit our documentation on [Set up SSO with Microsoft Entra ID Native App](./set-up-sso-with-microsoft-entra-ID-native-app.md).

This step-by-step guide explains how to set up [Single Sign-On](../single-sign-on.md) in Contentstack with Microsoft Azure Active Directory (AD) as your SAML 2.0 Identity Provider (IdP).
...
No. **Warning**: This set up guide is deprecated. Please visit our documentation on [Set up SSO with Microsoft Entra ID Native App](./set-up-sso-with-microsoft-entra-ID-native-app.md).
