...
- ## Developing Content Type
    ...
    **Product Listing Page** Content Type:
      ...
      **Title**: This is where you need to provide your “Product Listing Us" page a name. The [Title](../create-content-types/title.md) field defines the title of the Product Listing page/entry.
- **URL**: Here goes the web URL of your “Product Listing" page. When clicked on, this link provided in the [URL ](../create-content-types/url.md)field takes users straight to your Product Listing page.
- **Page Components**: The different sections that you see on your “Product Listing" page have been collectively considered together, and hence have used the [Modular Block](../create-content-types/modular-blocks.md) field to create the following components:
          **Hero Banner**: This is the first block which is a big, bold section at the top of your page, usually with standout images or messages. In this block, a [reference](../create-content-types/reference.md) field is used to fetch content from the [Hero Banner](./hero-banner.md#developing-content-type) content type.
- **Product:** This is the second block where you will be able to see the list of related products. For this block, a [reference](../create-content-types/reference.md) field is used to fetch content from the **Product** content type as explained in the section below.
- **Widget: **This is the third block that includes the list of products on your page. Your list can appear in cards that contain multiple details.
              **Title H2:** This is a [Single Line Textbox](../create-content-types/single-line-textbox.md) field that defines the title of this widget section.
- **Related Products: **This is a [Reference](../create-content-types/reference.md#self-referencing) field that refers to the **Product Listing Page** content type.
- **SEO**: The SEO [Global](../global-field/about-global-field.md) field consists of multiple fields, as listed below:
          **Meta Title: **Meta Title is a [Single Line Textbox](../create-content-types/single-line-textbox.md) field where you can add the meta title of your entry.
- **Meta Description: **Meta Descriptions is a [Multi Line Textbox](../create-content-types/multi-line-textbox.md) field where you can add the meta description of your entry.
- **Meta Keywords: **Meta Keywords is a [Single Line Textbox](../create-content-types/single-line-textbox.md) field where you can add the meta keywords of your entry.
- **Enable Search Indexing: **You can enable or disable the searches in this [Boolean](../create-content-types/boolean.md) field. If you turn it on, it makes sure search engines can find your page. If you turn it off, it keeps the page more private.
...
- **Call To Action**: This is a [Link](../create-content-types/link.md) field that stores the button name as a title and URL for submitting product details.
...
A: The [Modular Block](../create-content-types/modular-blocks.md) field is used to create the Page Components.

**Q: Which content type is referenced to fetch hero banner content?**  
A: A [reference](../create-content-types/reference.md) field is used to fetch content from the [Hero Banner](./hero-banner.md#developing-content-type) content type.
