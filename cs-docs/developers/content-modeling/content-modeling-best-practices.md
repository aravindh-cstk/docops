...
[Content modeling](./about-content-modeling.md) in Contentstack is the process of defining the structure of your [content types](../create-content-types/about-content-types.md) to ensure efficient, reusable, and scalable content management. There are certain best practices that you can follow to make sure you model the content in the recommended way.
...
Do not use reserved keywords in unique identifiers (UIDs). Refer to the [Restricted Keywords for UIDs](../create-content-types/restricted-keywords-for-uids.md) document for a complete list. This ensures smooth API query execution and avoids potential issues.

**Note**: Refrain from using hyphens (-) in content type UIDs.

## Use “Reference” Fields for Reusable Content
[Reference](../create-content-types/reference.md) fields allow you to link entries across different content types, promoting consistency and reusability. This field type is ideal when you have data shared among multiple entries. Consider the following use cases where Reference fields can be effectively utilized:
...
[Group](../create-content-types/group.md) fields help organize related fields into a single, reusable structure. This is useful for components such as banners, footers, and call-to-action sections where multiple elements are grouped together.
...
[Modular Blocks](../create-content-types/modular-blocks.md) provide flexibility by allowing content managers to dynamically select and arrange different content structures within a single field. This is particularly useful for pages with varying layouts.
...
**Additional Resource: **Refer to the [Modular Blocks – Real World Scenarios](../create-content-types/modular-blocks.md#modular-blocks-real-world-scenarios) guide for practical examples.

## Use “Global” Fields for Reusable Fields
[Global](../global-field/about-global-field.md) fields allow you to create a set of fields once and reuse them across multiple content types. This is ideal for fields that need to appear consistently across different content types.
...
- **Color Picker**: Use the Contentstack [Color Picker](../marketplace-apps/color-picker.md) app to dynamically adjust colors on web pages or apply product filters in eCommerce websites.
- **Ace Editor**: Integrate the [Ace Editor](../marketplace-apps/ace-editor.md) app to write and edit code with syntax highlighting and multi-language support directly in Contentstack.
- **Star Ratings**: Use the [Star Ratings](../marketplace-apps/star-ratings.md) app to add rating systems, such as approval ratings for movies, to your entries.
- **Third-party integrations**: Custom fields can also be used to integrate with external platforms such as [Shopify](../create-custom-fields/shopify.md), [Amazon S3](../create-custom-fields/amazon-s3.md), [YouTube](../marketplace-apps/youtube.md), [Optimizely](../marketplace-apps/optimizely.md), and so on.
...
Understanding the difference between [Reference](../create-content-types/reference.md) and [Select](../create-content-types/select.md) fields ensures you choose the right tool for your content needs.
...
[Boolean](../create-content-types/boolean.md) fields are perfect for managing simple true/false conditions. These fields provide a checkbox interface, making them easy to use for content managers.
...
- [**HTML Rich Text Editor**](../create-content-types/rich-text-editor.md): For advanced formatting like embedding videos, custom HTML, or adding styled text. Suitable for developers comfortable with HTML tags.
- [**JSON Rich Text Editor**](../json-rich-text-editor/about-json-rich-text-editor.md): For structured content where formatting is applied via UI buttons. Ideal for embedding social media content or creating uniform styling.
- [**Markdown Editor**](../create-content-types/markdown.md): For text-heavy content formatted using Markdown syntax. Easy to read and write, making it a good choice for simple text formatting.
