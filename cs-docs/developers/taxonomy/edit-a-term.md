...
To edit terms via the API, refer to the [Edit a Term](../../../api-docs/api-detail/content-management-api.md#update-a-term) API request.
...
Use the API request referenced in **API Reference**: [Edit a Term](../../../api-docs/api-detail/content-management-api.md#update-a-term).
