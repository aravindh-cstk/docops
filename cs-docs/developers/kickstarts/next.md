...
- Get your **Organization ID** from the Contentstack dashboard: Go to Org Admin > **Info** and copy the Org ID:![Get-Org-ID](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/blt250c40ce6173b773/680254ba9a3191443e63edc7/get-orgID.png)
- Seed your Stack:
```
