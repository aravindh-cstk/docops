...
**Note: **This page is no longer maintained, and the underlying code may be outdated or unsupported. It may be removed in a future release. To learn the recommended way to back up and migrate Contentstack content, refer to the [CLI](../cli/migrate-your-content-using-the-cli-migration-command.md) documentation.

Backing up content means creating and maintaining copies of your stack’s [entries](../../content-managers/author-content/about-entries.md) and [assets](/docs/content-managers/working-with-assets/about-assets). Backups help when there is a natural disaster, or you accidentally delete content, or you want to go through some old deleted records.
...
- So, every time you [publish](/docs/content-managers/publish-content), delete, or [update an entry](../../content-managers/author-content/edit-an-entry.md) or asset, the corresponding changes are made automatically on your database. Read more about Contentstack [DataSync](../develop-apps-with-datasync/about-contentstack-datasync.md).
- ## Create Backups in Your Local Storage System
- You can [set up webhooks](../set-up-webhooks/create-a-webhook.md) that trigger on every create, update, delete or publish event, and write scripts that store this webhook data on your local storage system. This way, you'll always have the most updated backup of your content.
- ## Periodic Back up of Stack Content Using 'Export' Script
- This is another simple way to create back up periodically. Use the Contentstack [Export script](../content-migration/migrate-content-between-stacks-within-contentstack.md) to export all the content of your stack in JSON files. You can do this periodically, and replace the earlier back up with the old ones or keep several backups. When required, you can either import content into any [stack](../set-up-stack/about-stack.md) of your choice or use it in any other way.
...
A: To learn the recommended way to back up and migrate Contentstack content, refer to the [CLI](../cli/migrate-your-content-using-the-cli-migration-command.md) documentation.
