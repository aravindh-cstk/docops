...
The Website Footer Content Model contains the **Footer** [Content Types](../../create-content-types/about-content-types.md) and **Social Share** [Global Field](../../create-content-types/global.md).

### Schema for Footer Content Type
- **Title**: This is a [Title](../../create-content-types/title.md) field that defines the title of the Website Footer entry. This is a mandatory field and must be unique.
- **Logo**: This is a [File](../../create-content-types/file.md) field that allows you to choose the website logo and add it to the entry. This is a mandatory field. Ideally, the image file for the logo should be less than 100KB in a PNG format.
- **Navigation**: This is a [Group](../../create-content-types/group.md) field which can be used to add multiple navigation items, with the following fields in it:**Link**: This is a [Link](../../create-content-types/link.md) field that adds a navigation menu item as a title and URL for redirection.
- **Open in new tab**: You can enable or disable the **Open in new tab** option using this [Boolean](../../create-content-types/boolean.md) field.
- **Social Media**: This is a **Social Share** [Global](../../create-content-types/global.md) field, and includes the following components:**Social Media Share**: This is a [Group](../../create-content-types/group.md) field that holds the following fields:**Title**: This is a [Title](../../create-content-types/title.md) field that defines the title for the Social Media Share.
- **Icon**: This is a [File](../../create-content-types/file.md) field that allows you to choose the social media icon and add it to the footer. Ideally, the image file for the icon should be less than 100KB in a PNG format.
- **URL**: This is a [Link](../../create-content-types/link.md) field that adds a social media name as a title and links it for redirection.
- **Copyright**: This is a [JSON Rich Text Editor](../../json-rich-text-editor.md) field that holds the legal copyright information of the website.

**Additional Resource**: You can import the prebuilt Content Models via the Marketplace (refer to [How to Import a Content Model](./how-to-import-content-model.md)) or via the CMS (refer to [Import Prebuilt Content Models to your Stack](../../create-content-types/import-prebuilt-content-models.md)). Refer the [Website Footer Content Modeling](../../content-modeling/website-footer.md) documentation to understand how to model the "Website Footer".
