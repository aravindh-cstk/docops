...
# [Marketplace guides and apps] - App Submission and Approval Guide

This page explains how to submit a public app to the Contentstack Marketplace and what to expect during review, testing, security checks, and publishing. It is intended for developers and partners preparing an app for Marketplace listing or updating an existing app.
...
To submit your app for review, follow the requirements below and submit your app through these forms:
- [New App Submission](https://docs.google.com/forms/d/e/1FAIpQLSf7JdG2sA-6CXTlH75O_KRum9WtpMgxVH9h78yRaTvregjfuQ/viewform)
- [Existing App Update Submission](https://docs.google.com/forms/d/e/1FAIpQLSc72MMd_aD-b0zxWSHq0yV8MchuxHDeuALy-hzTy3Qevl8w5g/viewform)

**Note:** This guide may be updated as and when new features are added to the Marketplace that may impact the review process. Reach out to our [support](mailto:support@contentstack.com) team if you have any concerns or feedback.
...
### Which form should I use to submit my app?
Use **New App Submission** for a new Marketplace app, and **Existing App Update Submission** to submit updates to an app that already exists.

### Are all metadata fields required?
Yes. The page states: **Note:** All fields are mandatory.

### What happens after my app is reviewed and approved?
After review and approval, the Marketplace team performs functional testing (requiring access to your organization and stack), then a security test, and then publishes the app after security tests and marketing content review.

### Do I need to provide documentation for my app listing?
Yes. You must provide a link to a dedicated documentation page accessible directly from your app listing.