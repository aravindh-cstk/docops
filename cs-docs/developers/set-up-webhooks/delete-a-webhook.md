...
To delete a webhook via API request, refer to the [Delete webhook](../../../api-docs/api-detail/content-management-api.md#delete-webhook) API request.

## Common questions

### Can I delete a webhook if I no longer need it?
Yes, Contentstack allows you to delete a [webhook](./about-webhooks.md) if you no longer need it.
...
Yes. Refer to the [Delete webhook](../../../api-docs/api-detail/content-management-api.md#delete-webhook) API request.
