...
- **Please connect to a git provider OAuth app before proceeding with the repair**:  
  ...
  Reconnect your Launch project to GitHub by following the steps in the [Create a Project Using GitHub](./import-project-using-github.md) documentation.
...
Reconnect your Launch project to GitHub by following the steps in the [Create a Project Using GitHub](./import-project-using-github.md) documentation, then proceed with Repair Connection.
