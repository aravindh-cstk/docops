...
url: https://www.contentstack.com/docs/launch/cloud-functions
...
The Launch Cloud Functions runtime environment leverages [**Node.js**](./supported-nodejs-versions.md) to power its execution environment.
...
- **Other**: Use [other framework with server command](./other-frameworks-on-launch.md#hosting-an-ssr-framework-site)

If a project with server-side functionality is detected, Launch Cloud Functions will be automatically disabled during deployment. This will be reflected in the [**Deployment Logs**](./deployments.md#deployment-logs) with the following message:
...
You can run your Launch project Cloud Functions locally using the [launch:functions](../cli/cli-for-launch.md#functions) command in CLI.
