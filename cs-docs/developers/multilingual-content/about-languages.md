...
Contentstack has a sophisticated multilingual capability. Using this, you can [create](../../content-managers/author-content/create-an-entry.md) and [publish](../../content-managers/author-content/publish-an-entry.md) [entries](../../content-managers/author-content/about-entries.md) in any language. Thus, this feature allows you to set up multilingual websites and cater to a wide variety of audiences by serving content in their local language(s). And all of this can be done without the need to code.

**Note:** When working within specific branches, languages added or created will be available only in that particular branch. Refer to our [Branch-specific Modules](../branches/branch-specific-modules.md) document for more information.

Contentstack supports [more than 200 languages](./list-of-supported-languages.md) to manage your content. Thus, you can create different content to meet the needs of different people in different places at different times.
...
If you want to work with languages that do not follow the [standard code formats](./supported-languages.md#code-standards), Contentstack allows you to [add custom languages](./add-a-custom-language.md) of your choice to the stack. Once generated, you will be able to create and publish entries in the custom languages too.

Contentstack supports [localization](./about-localization.md) where you can create multiple localized versions of a single entry in any of the supported languages as per your requirement.
...
You can [add custom languages](./add-a-custom-language.md) of your choice to the stack.

### Does Contentstack support localization for entries?
Yes. Contentstack supports [localization](./about-localization.md) where you can create multiple localized versions of a single entry in supported languages.