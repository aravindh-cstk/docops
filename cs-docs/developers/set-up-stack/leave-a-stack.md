...
# [Set Up Stack] - Leave a Stack

This page explains how to leave a Contentstack stack when you no longer need access or want to stop collaborating. It is intended for developers and stack users managing access, and should be used when you want to remove yourself from a stack (including understanding what owners must do instead).
