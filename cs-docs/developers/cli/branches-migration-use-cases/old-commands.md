...
[Branches](../../../../api-docs/developer-apis/content-management-api/branches.md) primarily help you sync between your code and content model without making significant changes to the code.
...
- Finally, you can deploy all the changes on your production branch. This can be done in the following two ways:  
  **Use an Alias for Release**:  This is an efficient way to apply new changes to your existing content. To use this method, create a production alias that points to the release branch.**Additional Resource**: Read our detailed guide on [how to use aliases](../../../../api-docs/developer-apis/content-management-api/branches.md#work-with-aliases) in content branching.
