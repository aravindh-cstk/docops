...
You can efficiently manage, transform, and optimize the assets in your [stack](../set-up-stack/about-stack.md).
...
- Hover over the **Asset Sidebar** location, and click the **+ Add** **UI Location** button.![Add_Asset_Sidebar_Location.png](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/blt04c721fe28ecc758/683571082e344b0ced49e7f7/Add_Asset_Sidebar_Location.png)
...
You can create new asset sidebar locations by writing your custom code, or you can use the prebuilt [boilerplate](./marketplace-app-boilerplate.md) and modify the given code to suit your requirements.
...
When enabled, Contentstack adds a JWT token to the initial HTTP request made for your app's first page. This token can be used to verify that the request originated from Contentstack. For more information, please refer to [Signed Locations](./securing-your-app.md).
