...
The **Image Dimension Validation** property of the [File](./file.md) field lets you set a filter or validation on the dimension of the images that users will upload on the [entry](../../content-managers/author-content/about-entries.md) page.

**Note**: In order to use this property, select the [Allow Images Only](./allow-images-only.md) property.
...
**Additional Resources**: To modify an image by tuning its various properties, you can check out our [Image Delivery API's](../../../api-docs/api-detail/image-delivery-api.md) extensive documentation.

## Common questions

### Do I need to enable anything before using Image Dimension Validation?
Yes. **Note**: In order to use this property, select the [Allow Images Only](./allow-images-only.md) property.
...
See **Additional Resources**: [Image Delivery API's](../../../api-docs/api-detail/image-delivery-api.md) extensive documentation.