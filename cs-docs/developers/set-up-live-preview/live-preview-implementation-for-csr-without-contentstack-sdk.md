...
url: https://www.contentstack.com/docs/headless-cms/live-preview-implementation-for-csr-without-contentstack-sdk
...
- **GCP EU:**` gcp-eu-rest-preview.contentstack.com`For other base urls like the CDN, refer to our documentation on [API Endpoints](../contentstack-regions/api-endpoints.md#base-api-urls-for-azure-north-america-region).
