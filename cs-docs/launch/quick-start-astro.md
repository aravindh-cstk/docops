...
- **Environment Name** (Mandatory): Enter the name of the environment.![Launch_Astro_CreateProjModal1.png](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/blt6a7f30c26d17a221/69ce4de3bbaed666a2320715/Launch_Astro_CreateProjModal1.png)
...
- Once ready, click **Deploy **to save and deploy the project.As soon as the deployment starts, the system displays the **Deploying **status as shown in the following screenshot:![Launch_Astro_Deploying_CancelFeature.png](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/blt4e20fa13b4f6cd41/69dc7ac21654a08b2a4f7669/Launch_Astro_Deploying_CancelFeature.png)
