...
2.  ### Create a GitHub Action
    ...
    1.  Create a [GitHub Action](https://docs.github.com/en/actions/quickstart) that triggers the deployment whenever a tag or a release is pushed to your repository.
