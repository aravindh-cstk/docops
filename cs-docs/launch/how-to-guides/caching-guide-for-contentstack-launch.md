...
-   Launch does not support **Next.js's ISR** or **App Router Data Cache**. Refer to the "_Does Launch support a data cache like Next.js App Router?_" query in the [Launch FAQs](/docs/launch/faqs) for alternatives.
...
-   Using [Automate](/docs/agent-os/launch-trigger) to trigger redeploy or webhook.
