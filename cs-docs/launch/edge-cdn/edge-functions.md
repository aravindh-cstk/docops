...
1.  Ensure that the root directory has a /functions folder.
2.  Add a \[proxy\].edge.js file.
3.  While setting up the project, by [Importing from a Git Repository](/docs/launch/import-project-using-github/) or [Uploading a file](/docs/launch/import-project-using-file-upload/), set the **Framework Preset** to Other.
4.  If the Edge Function has dependency packages, follow the steps below:
    1.  Ensure that a package.json file is present at the root directory.
    2.  Set Build Command to npm install to install the dependency packages.
...
![Launch_EdgeFunctions_ServerLogs.png](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/bltad1e86eb5b594586/665d8fd03c5297be16003318/Launch_EdgeFunctions_ServerLogs.png)
