...
![Launch_Nuxt_Logs.png](https://images.contentstack.io/v3/assets/blt2d43f51baca745a8/blt0981d9a921049d02/685b7af07a146a67550592a7/Launch_Nuxt_Logs.png)

**Additional Resource:** Explore our [Kickstart Nuxt](/docs/headless-cms/nuxt) guide for step-by-step instructions to set up and run a Nuxt project integrated with Contentstack.
