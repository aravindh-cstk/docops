...
url: developers/apis/image-delivery-api/requests/crop-by-aspect-ratio
...
| crop | 1:3 | Enter the width and height of the crop area in aspect ratio.  The format of the parameter is: crop={width_value}:{height_value} |
