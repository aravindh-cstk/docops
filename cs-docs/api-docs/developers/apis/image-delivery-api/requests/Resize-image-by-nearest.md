...
url: developers/apis/image-delivery-api/requests/resize-image-by-nearest
...
| resize-filter | nearest | Enter the value for the resizing filter to be used to resize the image.  The format of the parameter is: resize-filter={resize-filter_value} |
