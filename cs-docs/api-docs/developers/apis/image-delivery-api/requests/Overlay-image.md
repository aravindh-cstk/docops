---
title: "Overlay image"
description: GET /assets/{stack_api_key}/{asset_uid}/{file_uid}/filename.jpg?environment={environment_name}&overlay={relative_URL}
url: developers/apis/image-delivery-api/requests/overlay
