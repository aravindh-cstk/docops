...
| content_type_uid | your_content_type_uid | Enter the unique ID of the content type that contains entries with embedded objects. The uid is generated based on the title of the content type. The unique ID  |
