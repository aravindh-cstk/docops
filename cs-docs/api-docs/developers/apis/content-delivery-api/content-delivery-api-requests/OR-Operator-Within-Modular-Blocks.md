...
description: GET /content_types/{content_type_uid}/entries?locale={locale_code}&query={'$or':[{'modular_block_UID.block_UID.field1_UID': 'value1'},{'modular_block_UID.block_UID.field2_UID': 'value2'}]}
url: developers/apis/content-delivery-api/requests/or-operator-within-modular-blocks
