...
description: GET /content_types/{content_type_uid}/entries?locale={locale_code}&include[]={reference_field_UID}
url: developers/apis/content-delivery-api/requests/include-reference
