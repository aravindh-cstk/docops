...
description: GET /content_types/{content_type_uid}/entries?locale={locale_code}&query={'field_UID': { '$gte': 'value' }}
url: developers/apis/content-delivery-api/requests/greater-than-or-equal-to
