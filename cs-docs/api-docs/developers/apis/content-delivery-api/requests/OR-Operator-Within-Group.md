...
description: GET /content_types/{content_type_uid}/entries?locale={locale_code}&query={'$or':[{'group_UID.field1_UID': 'value1'},{'group_UID.field2_UID': 'value2'}]}
url: developers/apis/content-delivery-api/requests/or-operator-within-group
