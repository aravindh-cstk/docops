...
description: GET /content_types/{content_type_uid}/entries?locale={locale_code}&query={'modular_block_UID.block_UID.field_UID': { '$lt': 'value' }}
url: developers/apis/content-delivery-api/requests/less-than-operator-within-modular-blocks
