...
description: GET /taxonomies/entries?query={'taxonomies.taxonomy_uid' : { '$below': 'term_uid', 'levels' : 2}}
url: developers/apis/content-delivery-api/requests/below-operator
