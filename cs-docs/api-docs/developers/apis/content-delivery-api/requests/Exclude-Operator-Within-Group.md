...
description: GET /content_types/{content_type_uid}/entries?locale={locale}&except[BASE][]=group_UID.field_UID
url: developers/apis/content-delivery-api/requests/exclude-operator-within-group
