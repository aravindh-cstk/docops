...
description: GET /content_types/{content_type_uid}/entries?locale={locale_code}&query={'group_UID.field_UID': { '$lte': 'value' }}
url: developers/apis/content-delivery-api/requests/less-than-or-equal-to-within-group
