...
description: GET /content_types/{content_type_uid}/entries?locale={locale}&except[BASE][]=modular_block_UID.block_UID.field_UID
url: developers/apis/content-delivery-api/requests/exclude-operator-within-modular-blocks
