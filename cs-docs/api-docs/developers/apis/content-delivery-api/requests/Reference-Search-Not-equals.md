...
description: GET /content_types/{content_type_uid}/entries?environment={environment_name}&locale={locale_code}&query={'reference_field_uid':{'$nin_query':{'referenced_content_type's_field_uid':'value'}}}
url: developers/apis/content-delivery-api/requests/reference-search-not-equals
