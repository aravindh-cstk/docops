...
description: GET /content_types/{content_type_uid}/entries?locale={locale_code}&query={'modular_block_UID.block_UID.field_UID': { '$gt': 'value' }}
url: developers/apis/content-delivery-api/requests/greater-than-operator-within-modular-blocks
