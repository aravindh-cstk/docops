...
description: GET /content_types/{content_type_uid}/entries?locale={locale_code}&query={'modular_block_uid.block_uid.reference_field_uid':{'$nin_query':{'referenced_content_type's_field_uid':'value'}}}
url: developers/apis/content-delivery-api/requests/reference-search-not-equals-within-modular-blocks
