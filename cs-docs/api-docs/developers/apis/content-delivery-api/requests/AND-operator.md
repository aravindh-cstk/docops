---
title: "AND operator"
description: GET /content_types/{content_type_uid}/entries?locale={locale_code}&query={'$and':[{'field1_UID': 'value1'},{'field2_UID': 'value2'}]}
url: developers/apis/content-delivery-api/requests/and-operator
