---
title: "Count"
description: GET /content_types/{content_type_uid}/entries?locale={locale}&include_count={boolean_value}
url: developers/apis/content-delivery-api/requests/count
