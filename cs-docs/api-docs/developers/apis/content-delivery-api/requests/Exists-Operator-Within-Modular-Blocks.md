...
description: GET /content_types/{content_type_uid}/entries?locale={locale_code}&query={'modular_block_UID.block_UID.field_UID': { '$exists': true } }
url: developers/apis/content-delivery-api/requests/exists-operator-within-modular-blocks
