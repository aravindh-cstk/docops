---
title: "Exists"
description: GET /content_types/{content_type_uid}/entries?locale={locale_code}&query={'field_UID': { '$exists': true } }
url: developers/apis/content-delivery-api/requests/exists
