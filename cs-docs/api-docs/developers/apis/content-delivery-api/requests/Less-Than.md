---
title: "Less Than"
description: GET /content_types/{content_type_uid}/entries?locale={locale_code}&query={'field_UID': { '$lt': 'value' }}
url: developers/apis/content-delivery-api/requests/less-than
