...
// Helpers and types moved to lib/nav-shared.ts so scripts that only need
// slugify() do not have to satisfy this file's credential check at import time.
// Re-exported here because nav-apply.ts, nav-audit.ts and
// test-left-nav-linker.ts import them from this path.
export {
  LEFT_NAV_UID,
  DOCS_BASE_URL,
  PRODUCTION_ENV_UID,
...
export type { Entry, LeafKind, NavLeaf, NavIssue, NavTree } from "./lib/nav-shared.js";
