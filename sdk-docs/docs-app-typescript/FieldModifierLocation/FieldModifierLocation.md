---
title: "FieldModifierLocation"
description: "The `FieldModifierLocation` UI location enables field data transformation and manipulation. const fieldModifier = sdk.location.FieldModifierLocation; if (fieldModifier) { const field = fieldModifier.field; const entry = fieldModifier.entry; const stack = fieldModifier.stack; const frame = fieldModifier.frame; } It supports the following core objects: Entry Stack Frame Field"
url: "https://www.contentstack.com/developers/sdks/contentstack-app-sdk/typescript/reference/fieldmodifierlocation"
