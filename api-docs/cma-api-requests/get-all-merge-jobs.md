...
description: /stacks/branches_queue
url: /get-all-merge-jobs
product: Contentstack
doc_type: api-request
created_at: 2023-05-23T09:53:51.105Z
updated_at: 2023-07-26T12:05:03.054Z
---

# Get all merge jobs

<p>The <span data-type='inlineCode'>Get all merge jobs</span> request returns a list of all the recent merge jobs within a specific period.</p>
<p class="note"><strong>Note</strong>: By default, the last<strong> 100</strong> merge jobs are returned in the response.</p>
<h5>Get a Single Merge Job</h5>

**API Endpoint**: `/stacks/branches_queue`
