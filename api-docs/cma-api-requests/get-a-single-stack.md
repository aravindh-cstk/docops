...
url: /get-a-single-stack
product: Contentstack
doc_type: api-request
created_at: 2023-01-05T14:09:06.523Z
updated_at: 2023-11-23T05:40:16.900Z
---

# Get a single stack

<p>The <span data-type="inlineCode">Get a single stack</span>&nbsp;call fetches comprehensive details of a specific stack.<br></p>
...
- **api_key** (required)
  <p>Enter the API Key of the stack that you want to retrieve.</p>
- **authtoken** (required)
