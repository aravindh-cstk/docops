...
url: /create-a-dashboard-widget-with-source-url
product: Contentstack
doc_type: api-request
created_at: 2023-01-05T14:09:19.791Z
updated_at: 2025-07-29T04:14:44.603Z
---

# Create a Dashboard Widget with Source URL

<p>The <span data-type='inlineCode'>Create a Dashboard Widget with Source URL</span> request is used to upload an extension hosted externally.</p><p>To configure the permissions for your application via OAuth, include the <span data-type='inlineCode'>cm.extensions.management:write</span> scope.</p><p>In the ‘Body’ section, you need to provide details of the dashboard widget, such as its tags, title, external source link (src), data types, configuration details, set if the extension is a widget or field, enable the extension, and set the default width of the viewport to either full or half.</p>
