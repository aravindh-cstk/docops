---
title: "Test Add a stack role mapping"
description: /organizations/{organization_uid}/teams/{team_uid}/stack_role_mappings
url: /test-add-a-stack-role-mapping
product: Contentstack
doc_type: api-request
created_at: 2026-04-07T12:55:44.562Z
updated_at: 2026-04-07T12:55:44.562Z
---

# Test Add a Stack Role Mapping

<p>The <span data-type="inlineCode">Add a stack role mapping</span> request allows you to associate users from a specified team with the available stacks in your organization.</p>

<p>You need to pass the API key of the stack and the role UIDs in the request body as follows:</p>
