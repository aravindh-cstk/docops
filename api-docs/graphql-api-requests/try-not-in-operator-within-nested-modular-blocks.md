---
title: "Try 'Not In' Operator within Nested Modular Blocks"
description: /stacks/apiKey/explore
url: /try-not-in-operator-within-nested-modular-blocks
product: Contentstack
doc_type: api-request
created_at: 2023-01-05T14:09:18.786Z
updated_at: 2023-03-30T10:33:44.271Z
---

# Try 'Not In' Operator within Nested Modular Blocks

<p><strong>Not In Operator within Nested Modular Blocks</strong></p>
...
<p>If, for instance, you need to retrieve the entries where the value of the "Coupon Discount Rate" field does not fall in the given set, your query will look as follows:</p>
<pre>query {
  all_product(
    where: {
      additional_info: {
