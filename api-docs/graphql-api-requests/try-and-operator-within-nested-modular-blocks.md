---
title: "Try 'AND' Operator within Nested Modular Blocks"
description: /stacks/apiKey/explore
url: /try-and-operator-within-nested-modular-blocks
product: Contentstack
doc_type: api-request
created_at: 2023-01-05T14:09:18.811Z
updated_at: 2023-07-18T07:23:30.405Z
---

# Try 'AND' Operator within Nested Modular Blocks

<p><strong>AND Operator within Nested Modular Blocks</strong></p>
...
<p>If you want to retrieve entries in which the "Coupon Name" field is set to "Lucky Twenty" and the "Coupon Discount Rate" field is <strong>20</strong>, your query will look as follows:</p>
<pre>query {
  all_product(
    where: {
      AND: [
