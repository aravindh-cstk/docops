---
title: "Order by asc"
description: /content_types/{content_type_uid}/entries?locale={locale_code}&asc={field_UID}
url: /order-by-asc
product: Contentstack
doc_type: api-request
created_at: 2023-01-05T14:09:04.791Z
updated_at: 2024-07-01T05:28:56.345Z
---

# Order by asc

<p>When fetching entries, you can sort them in the ascending order with respect to the value of a specific field in the response body.</p>
<p>This query will work for both entries as well as assets.</p>
<p>Example: In the <span data-type='inlineCode'>Product</span> content type, if you wish to sort the entries with respect to their prices, the parameter can be used as:</p>
<p><span data-type='inlineCode'>https://cdn.contentstack.io/v3/content_types/product/entries?environment=production&amp;asc=price_in_usd</span></p>
<p>This will give you all the entries sorted in the ascending order with respect to the <span data-type='inlineCode'>Price in USD</span> field.</p>
...
<h5 id="order-by-asc-operator-within-group">Order by asc Operator Within Group</h5>

**API Endpoint**: `/content_types/{content_type_uid}/entries?locale={locale_code}&asc={field_UID}`
