---
title: "Limit"
description: /content_types/{content_type_uid}/entries?locale={locale_code}&limit={limit_value}
url: /limit
product: Contentstack
doc_type: api-request
created_at: 2023-01-05T14:09:02.460Z
updated_at: 2024-07-01T05:27:26.869Z
---

# Limit

<p>The limit parameter will return a specific number of entries in the output. So for example, if the content type contains more than 100 entries and you wish to fetch only the first 2 entries, you need to specify '2' as value in this parameter.</p><p>This query will work for both entries as well as assets.</p><p><strong>Example:</strong></p><p><span data-type='inlineCode'>https://cdn.contentstack.io/v3/content_types/product/entries?environment=production&amp;limit=2</span></p><p class="note"><strong>Note</strong>: By default, the limit for response details per request is 100.</p>

**API Endpoint**: `/content_types/{content_type_uid}/entries?locale={locale_code}&limit={limit_value}`
...
- **limit** (required)
  <p>Enter the maximum number of entries to be returned.</p>
