---
title: "Count"
description: /content_types/{content_type_uid}/entries?locale={locale}&include_count={boolean_value}
url: /count
product: Contentstack
doc_type: api-request
created_at: 2023-01-05T14:09:03.340Z
updated_at: 2024-07-01T05:37:19.990Z
---

# Count

<p>To retrieve the count of entries, we have two parameters: <span data-type='inlineCode'>include_count</span>&nbsp;(retrieves entries' details and their count) and <span data-type='inlineCode'>count</span>&nbsp;(retrieves only the count of entries).<span>This query will work for both entries as well as assets.</span></p><p><strong>Example:</strong> If you wish to know the total number of entries in the <span data-type='inlineCode'>Product</span> content type and also retrieve all the data, you need to run the following API request:</p><pre>https://cdn.contentstack.io/v3/content_types/product/entries?environment={environment}&amp;include_count=true</pre><p>To get only the count, run the following API request:</p><pre>https://cdn.contentstack.io/v3/content_types/product/entries?environment={environment}&amp;count=true</pre>

**API Endpoint**: `/content_types/{content_type_uid}/entries?locale={locale}&include_count={boolean_value}`
...
- **include_count** (required)
  <p>Enter 'true' to get the total count of the entries and their details.</p>
...
- **count** (optional)
  <p>Enter 'true' to only get the count of entries.</p>
